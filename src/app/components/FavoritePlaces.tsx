...
.fpd-fav .hbanner h1{font-family:var(--font-display);font-size:36.5px;font-weight:700;line-height:1.14;letter-spacing:-0.02em;margin:0 0 10px;color:${TEXT};}
...
.fpd-fav .hbanner p{color:${SOFT};font-size:17px;line-height:1.6;max-width:400px;margin:0 0 20px;}
.fpd-fav .hbanner .hactions{display:flex;gap:10px;flex-wrap:wrap;}
.fpd-fav .hbanner .hbtn{display:inline-flex;align-items:center;gap:8px;padding:11px 18px;border-radius:99px;font-size:15.5px;font-weight:700;cursor:pointer;font-family:var(--font-body);border:none;transition:transform .18s,filter .18s;}
...
@media (max-width:640px){.fpd-fav .hbanner{min-height:auto;} .fpd-fav .hbanner .hcontent{padding:24px 22px;max-width:none;} .fpd-fav .hbanner h1{font-size:29px;}}

.fpd-fav .card{background:#101728;border:1px solid rgba(255,255,255,0.06);border-radius:22px;}
.fpd-fav .card.pad{padding:28px;}
.fpd-fav .eyebrow{font-size:12.5px;font-weight:600;color:${MUTED};display:flex;align-items:center;gap:7px;}

/* header */
.fpd-fav .pg-head{display:flex;align-items:flex-end;justify-content:space-between;gap:20px;flex-wrap:wrap;}
.fpd-fav .pg-h1{font-size:30px;color:${TEXT};font-weight:600;margin:9px 0 5px;letter-spacing:-0.02em;font-family:var(--font-display);}
.fpd-fav .pg-sub{color:${MUTED};font-size:16px;max-width:640px;line-height:1.6;}
...
.fpd-fav .btn-ghost{display:inline-flex;align-items:center;gap:7px;padding:9px 15px;border-radius:99px;background:rgba(91,110,225,0.10);border:1px solid rgba(91,110,225,0.28);color:#6FAE8B;font-size:15.5px;font-weight:600;cursor:pointer;font-family:var(--font-body);transition:background .18s;border:none;}
.fpd-fav .btn-ghost:hover{background:rgba(91,110,225,0.18);}
.fpd-fav .btn-sec{display:inline-flex;align-items:center;gap:7px;padding:9px 15px;border-radius:99px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);color:${MUTED};font-size:15.5px;font-weight:600;cursor:pointer;font-family:var(--font-body);}
...
.fpd-fav .kcell .klbl{font-size:12px;font-weight:600;color:${MUTED};}
...
.fpd-fav .kcell .kval{font-family:var(--font-display);font-size:32.5px;font-weight:600;color:${TEXT};line-height:1;letter-spacing:-0.02em;font-variant-numeric:tabular-nums;}
.fpd-fav .kcell .ksub{font-size:14.5px;color:${MUTED};margin-top:9px;display:flex;align-items:center;gap:6px;}
...
.fpd-fav .search-input{width:220px;padding:9px 13px;border-radius:99px;background:#0F1624;border:1px solid rgba(255,255,255,0.08);color:${TEXT};font-size:15.5px;outline:none;font-family:var(--font-body);transition:border-color .18s,box-shadow .18s;}
...
.fpd-fav .chip{display:inline-flex;align-items:center;gap:7px;padding:7px 11px;border-radius:99px;font-size:15px;font-weight:600;cursor:pointer;font-family:var(--font-body);border:1px solid;transition:opacity .16s,background .16s,border-color .16s;}
...
.fpd-fav .pico{width:46px;height:46px;border-radius:16px;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:27.5px;}
.fpd-fav .pname{font-family:var(--font-display);font-size:20px;color:${TEXT};font-weight:600;margin-bottom:2px;letter-spacing:-0.01em;}
.fpd-fav .pcat{font-family:var(--font-mono);font-size:13.5px;font-weight:700;letter-spacing:0.04em;margin-bottom:5px;}
...
.fpd-fav .paddr{display:flex;align-items:center;gap:6px;color:${MUTED};font-size:15px;margin-bottom:10px;}
...
.fpd-fav .pfav .pfk{color:${WARN};font-family:var(--font-mono);font-size:11px;letter-spacing:0.08em;margin-bottom:3px;}
.fpd-fav .pfav .pfv{color:${TEXT};font-size:15.5px;line-height:1.5;}
.fpd-fav .pwhy{color:${MUTED};font-size:15px;line-height:1.65;font-style:italic;margin-bottom:12px;}
...
.fpd-fav .ptag{padding:3px 9px;border-radius:6px;font-size:14px;font-weight:500;background:rgba(91,110,225,0.10);color:#6FAE8B;}
.fpd-fav .pvisited{color:${MUTED};font-size:13.5px;font-family:var(--font-mono);flex-shrink:0;}
.fpd-fav .pacts{display:flex;gap:8px;flex-wrap:wrap;}
.fpd-fav .pact-btn{display:inline-flex;align-items:center;gap:6px;padding:7px 11px;border-radius:16px;font-size:14.5px;font-weight:600;cursor:pointer;border:none;font-family:var(--font-body);background:rgba(91,110,225,0.08);color:#6FAE8B;transition:background .16s;}
...
.fpd-fav .empty .et{color:${SOFT};font-size:17.5px;font-weight:600;font-family:var(--font-display);margin-bottom:4px;}
.fpd-fav .empty .ed{color:${MUTED};font-size:15.5px;}
...
.fpd-fav .modal-head h3{font-family:var(--font-display);font-size:20px;color:${TEXT};font-weight:600;}
...
.fpd-fav .field label{display:block;margin-bottom:6px;font-size:12px;font-weight:600;color:${MUTED};}
.fpd-fav .field input,.fpd-fav .field select,.fpd-fav .field textarea{width:100%;padding:11px 13px;border-radius:18px;background:#0F1624;border:1px solid rgba(255,255,255,0.08);color:${TEXT};font-size:16px;outline:none;font-family:var(--font-body);transition:border-color .18s,box-shadow .18s;}
...
.fpd-fav .modal-foot .save{flex:1;padding:12px;border-radius:18px;font-size:16px;font-weight:700;border:none;cursor:pointer;background:linear-gradient(180deg,#7E6BD8,#5B6EE1);color:#fff;font-family:var(--font-body);transition:filter .18s;}
