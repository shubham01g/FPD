...
.fpd-daycare .card{background:linear-gradient(180deg,#0D1421 0%,#0A0F1A 100%);border:1px solid rgba(255,255,255,0.34);border-radius:15px;box-shadow:inset 0 1px 0 rgba(255,255,255,0.035),0 10px 34px -18px rgba(0,0,0,0.7);}
...
.fpd-daycare .btn-sec{display:inline-flex;align-items:center;gap:7px;padding:9px 15px;border-radius:9px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.34);color:${MUTED};font-size:12.5px;font-weight:600;cursor:pointer;font-family:var(--font-body);}

/* segmented sub-tabs (per record) */
.fpd-daycare .seg{display:flex;gap:3px;padding:3px;border-radius:12px;background:#0F1624;border:1px solid rgba(255,255,255,0.34);width:fit-content;flex-wrap:wrap;}
...
.fpd-daycare .rbody{border-top:1px solid rgba(255,255,255,0.34);}
...
.fpd-daycare .igrid{display:grid;grid-template-columns:1fr 1fr;border-radius:11px;background:#0F1624;border:1px solid rgba(255,255,255,0.34);overflow:hidden;}
.fpd-daycare .igrid .tile:nth-child(2n){border-left:1px solid rgba(255,255,255,0.34);}
.fpd-daycare .igrid .tile:nth-child(n+3){border-top:1px solid rgba(255,255,255,0.34);}
@media (max-width:760px){
.fpd-daycare .igrid{grid-template-columns:1fr;}
.fpd-daycare .igrid .tile:nth-child(2n){border-left:none;}
.fpd-daycare .igrid .tile:nth-child(n+2){border-top:1px solid rgba(255,255,255,0.34);}
}
...
.fpd-daycare .modal-head{display:flex;align-items:center;justify-content:space-between;padding:18px 22px;border-bottom:1px solid rgba(255,255,255,0.34);}
...
.fpd-daycare .field input,.fpd-daycare .field select,.fpd-daycare .field textarea{width:100%;padding:11px 13px;border-radius:10px;background:#0F1624;border:1px solid rgba(255,255,255,0.34);color:${TEXT};font-size:13px;outline:none;font-family:var(--font-body);transition:border-color .18s,box-shadow .18s;}
...
.fpd-daycare .modal-foot{display:flex;align-items:center;gap:10px;padding:16px 22px;border-top:1px solid rgba(255,255,255,0.34);flex-wrap:wrap;}
.fpd-daycare .modal-foot .save{flex:1;padding:12px;border-radius:10px;font-size:13px;font-weight:700;border:none;cursor:pointer;background:linear-gradient(180deg,#7E6BD8,#5B6EE1);color:#fff;font-family:var(--font-body);transition:filter .18s;}
