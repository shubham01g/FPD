...
.fpd-daycare .hbanner h1{font-family:var(--font-display);font-size:32.5px;font-weight:700;line-height:1.14;letter-spacing:-0.02em;margin:0 0 10px;color:${TEXT};}
...
.fpd-daycare .hbanner p{color:${SOFT};font-size:15px;line-height:1.6;max-width:400px;margin:0 0 20px;}
.fpd-daycare .hbanner .hactions{display:flex;gap:10px;flex-wrap:wrap;}
.fpd-daycare .hbanner .hbtn{display:inline-flex;align-items:center;gap:8px;padding:11px 18px;border-radius:99px;font-size:14px;font-weight:700;cursor:pointer;font-family:var(--font-body);border:none;transition:transform .18s,filter .18s;}
...
@media (max-width:640px){.fpd-daycare .hbanner{min-height:auto;} .fpd-daycare .hbanner .hcontent{padding:24px 22px;max-width:none;} .fpd-daycare .hbanner h1{font-size:26px;}}
...
.fpd-daycare .eyebrow{font-size:11px;font-weight:600;color:${MUTED};display:flex;align-items:center;gap:7px;}

/* header */
.fpd-daycare .pg-head{display:flex;align-items:flex-end;justify-content:space-between;gap:20px;flex-wrap:wrap;}
.fpd-daycare .pg-h1{font-size:27px;color:${TEXT};font-weight:600;margin:9px 0 5px;letter-spacing:-0.02em;font-family:var(--font-display);}
.fpd-daycare .pg-sub{color:${MUTED};font-size:14.5px;max-width:660px;line-height:1.6;}
...
.fpd-daycare .btn-sec{display:inline-flex;align-items:center;gap:7px;padding:9px 15px;border-radius:99px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);color:${MUTED};font-size:14px;font-weight:600;cursor:pointer;font-family:var(--font-body);}
...
.fpd-daycare .seg button{display:inline-flex;align-items:center;gap:7px;padding:9px 16px;border-radius:99px;font-size:14px;font-weight:600;color:${MUTED};background:none;border:none;cursor:pointer;font-family:var(--font-body);transition:color .18s,background .18s;}
...
.fpd-daycare .rname{font-family:var(--font-display);font-size:18.5px;color:${TEXT};font-weight:600;letter-spacing:-0.01em;}
.fpd-daycare .rchild{color:${SOFT};font-size:14.5px;font-weight:500;margin-bottom:6px;}
.fpd-daycare .rmeta{display:flex;align-items:center;gap:14px;flex-wrap:wrap;}
.fpd-daycare .rmeta span{display:flex;align-items:center;gap:5px;color:${MUTED};font-size:13px;}
.fpd-daycare .stat-badge{display:inline-flex;align-items:center;padding:3px 10px;border-radius:99px;font-family:var(--font-mono);font-size:11px;font-weight:700;letter-spacing:0.04em;}
...
.fpd-daycare .tile .tk{font-size:10.5px;font-weight:600;color:${MUTED};margin-bottom:5px;}
.fpd-daycare .tile .tv{color:${TEXT};font-size:14.5px;line-height:1.5;}
...
.fpd-daycare .alert .ak{color:${NEG};font-family:var(--font-mono);font-size:12px;font-weight:700;letter-spacing:0.06em;margin-bottom:4px;}
.fpd-daycare .alert .av{color:${TEXT};font-size:14.5px;}
.fpd-daycare .alert .am{color:${MUTED};font-size:13.5px;margin-top:4px;}
...
.fpd-daycare .notebox .nk{color:${WARN};font-family:var(--font-mono);font-size:11px;letter-spacing:0.06em;margin-bottom:6px;}
.fpd-daycare .notebox .nv{color:${TEXT};font-size:14.5px;line-height:1.6;}

/* authorized pickups */
.fpd-daycare .pickup-intro{color:${MUTED};font-size:14px;line-height:1.65;}
...
.fpd-daycare .pavatar{width:40px;height:40px;border-radius:50%;flex-shrink:0;display:flex;align-items:center;justify-content:center;background:rgba(91,110,225,0.14);color:#6FAE8B;font-family:var(--font-display);font-weight:700;font-size:15.5px;}
.fpd-daycare .pinfo-name{display:flex;align-items:center;gap:8px;margin-bottom:3px;flex-wrap:wrap;}
.fpd-daycare .pinfo-name b{color:${TEXT};font-size:15.5px;font-weight:600;}
.fpd-daycare .pinfo-name span{color:${MUTED};font-size:13.5px;}
.fpd-daycare .pinfo-row{display:flex;align-items:center;gap:6px;color:${MUTED};font-size:13px;}
.fpd-daycare .pinfo-row.ok{color:#D99A6B;margin-top:3px;}
.fpd-daycare .adddash{width:100%;padding:12px;border-radius:16px;border:1px dashed rgba(91,110,225,0.4);background:rgba(91,110,225,0.04);color:#6FAE8B;font-size:14px;font-weight:600;display:flex;align-items:center;justify-content:center;gap:8px;cursor:pointer;font-family:var(--font-body);transition:background .18s;}
.fpd-daycare .adddash:hover{background:rgba(91,110,225,0.09);}

/* documents */
.fpd-daycare .docrow{display:flex;flex-wrap:wrap;gap:8px;}
.fpd-daycare .docchip{display:inline-flex;align-items:center;gap:7px;padding:9px 13px;border-radius:18px;font-size:13.5px;background:rgba(91,110,225,0.08);color:#6FAE8B;border:1px solid rgba(91,110,225,0.18);cursor:pointer;font-family:var(--font-body);transition:background .16s;}
...
.fpd-daycare .modal-head h3{font-family:var(--font-display);font-size:18px;color:${TEXT};font-weight:600;}
...
.fpd-daycare .field label{display:block;margin-bottom:6px;font-size:10.5px;font-weight:600;color:${MUTED};}
.fpd-daycare .field input,.fpd-daycare .field select,.fpd-daycare .field textarea{width:100%;padding:11px 13px;border-radius:18px;background:#0F1624;border:1px solid rgba(255,255,255,0.08);color:${TEXT};font-size:14.5px;outline:none;font-family:var(--font-body);transition:border-color .18s,box-shadow .18s;}
...
.fpd-daycare .modal-foot .save{flex:1;padding:12px;border-radius:18px;font-size:14.5px;font-weight:700;border:none;cursor:pointer;background:linear-gradient(180deg,#7E6BD8,#5B6EE1);color:#fff;font-family:var(--font-body);transition:filter .18s;}
