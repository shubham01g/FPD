  ...
  return (
    <>
      <button
        ...
        style={{ background:"rgba(108,92,231,0.07)", color:"var(--primary)", border:"1px solid rgba(108,92,231,0.18)" }}>
        <FolderOpen size={11}/>
      ...
      {open && (
        <div
          ...
          <div className="px-3 py-2 border-b" style={{ borderColor:"var(--border)", background:"rgba(108,92,231,0.03)" }}>
