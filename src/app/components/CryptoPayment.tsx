          ...
          {step === "awaiting" && (
            <div className="space-y-5 text-center">
              ...
              <div className="space-y-2 text-left">
                ...
                <div className="flex items-start gap-2 px-3 py-2.5 rounded-xl"
                  style={{ background:"rgba(32,64,192,0.08)", border:"1px solid rgba(32,64,192,0.15)" }}>
                  <Shield size={12} color="#6090FF" style={{ marginTop:1, flexShrink:0 }}/>
                  <p style={{ color:"#6090FF", fontSize:11, lineHeight:1.6 }}>
