        ...
        <div className="flex gap-1 p-1 rounded-xl w-fit" style={{ background:"rgba(255,255,255,0.9)", border:"1px solid rgba(91,110,225,0.1)" }}>
          {TABS.map(t => (
            <button key={t.id} onClick={() => setTab(t.id)}
              ...
              style={{ background:tab===t.id?"#5B6EE1":"transparent", color:tab===t.id?"#fff":"#5A6A88" }}>
              {t.label}
            </button>
          ))}
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl overflow-auto" style={{ border:"1px solid rgba(91,110,225,0.1)" }}>
              <table className="w-full text-sm">
                <thead>
                  <tr style={{ background:"#EAF0FC", borderBottom:"1px solid rgba(91,110,225,0.1)" }}>
            ...
            {packages.map(pkg => (
              <div key={pkg.id} className="p-5 rounded-2xl glow-surface" style={CARD}>
                ...
                <div className="flex items-center gap-2 p-3 rounded-xl mb-3 glow-surface"
                  style={{ background:"#F5F8FE", border:"1px solid rgba(91,110,225,0.1)" }}>
