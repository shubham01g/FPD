  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="p-6 rounded-2xl border" style={{ background: "var(--card)", borderColor: "var(--border)" }}>
        <h3 style={{ fontFamily: "var(--font-display)", fontSize: 20, color: "var(--foreground)", marginBottom: 16 }}>Tier Distribution & Earnings</h3>
              ...
              <div key={i}>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div>
                    ...
                    <span style={{ color: "var(--gold)", fontFamily: "var(--font-mono)", fontSize: 15 }}>${t.earn.toLocaleString()}/mo</span>
                  </div>
                </div>
        ...
        {filtered.map((aff, i) => (
          ...
          >
            ...
            <div>
              ...
              <div style={{ color: "var(--muted-foreground)", fontSize: 14 }}>{aff.email}</div>
            </div>
            <div className="flex items-center gap-1.5">
              <div className="rounded-full" style={{ width: 8, height: 8, background: (tierColors as any)[aff.tier] }} />
              <span style={{ color: (tierColors as any)[aff.tier], fontSize: 15, fontFamily: "var(--font-mono)", fontWeight: 700 }}>{(tierLabels as any)[aff.tier]} · {aff.rate}%</span>
            </div>
            <span style={{ color: "var(--foreground)", fontFamily: "var(--font-mono)", fontSize: 16 }}>{aff.activeReferrals}</span>
            <span style={{ color: "var(--gold)", fontFamily: "var(--font-mono)", fontSize: 16 }}>${aff.monthlyEarn.toFixed(2)}</span>
            <span style={{ color: "var(--foreground)", fontFamily: "var(--font-mono)", fontSize: 16 }}>${aff.totalEarned.toLocaleString()}</span>
            <div
