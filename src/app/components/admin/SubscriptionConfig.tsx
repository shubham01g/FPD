...
const initialPlans: PlanConfig[] = [
  ...
  { id: "family_archive", name: "Legacy Archive", price: 24.99,  annualDiscount: 20, storage: 250,  overageRate: 0.40, maxContacts: 999, color: "#6C5CE7" },
  { id: "legacy_pro",     name: "Legacy Pro",     price: 49.99,  annualDiscount: 20, storage: 500,  overageRate: 0.40, maxContacts: 999, color: "#9F7AEA" },
    ...
    <div className="p-6 space-y-6" style={{ maxWidth: 1000 }}>
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            style={{
              background: saved ? "rgba(72,187,120,0.15)" : "linear-gradient(135deg, #6C5CE7, #4466D8)",
      ...
      <div className="flex justify-end">
        <button
          ...
          style={{ background: "linear-gradient(135deg, #6C5CE7, #4466D8)", color: "#070D1A", fontWeight: 700, fontSize: 15 }}
        >
