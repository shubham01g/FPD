...
const templates: EmailTemplate[] = [
  {
    ...
    html: `<div style="font-family:'DM Sans',sans-serif;background:#04080F;color:#E8EDF5;max-width:600px;margin:0 auto;border-radius:16px;overflow:hidden;border:1px solid rgba(58,91,217,0.15)">
  <div style="background:linear-gradient(135deg,#060F1E,#0A1628);padding:40px;text-align:center;border-bottom:1px solid rgba(58,91,217,0.15)">
    <img src="https://finalpassdown.com/logo.png" alt="Final Pass Down" style="height:50px;margin-bottom:16px"/>
    <h1 style="color:#3A5BD9;font-size:22px;margin:0;font-weight:700">Welcome to Final Pass Down</h1>
  ...
  <div style="padding:40px">
    ...
    <p style="color:#8AA3C8;font-size:14px;line-height:1.8">Welcome to Final Pass Down — you've taken the most important step in protecting your family's future. Your <strong style="color:#3A5BD9">{{plan_name}}</strong> vault is now active and ready.</p>
    <div style="background:rgba(58,91,217,0.08);border:1px solid rgba(58,91,217,0.2);border-radius:12px;padding:24px;margin:24px 0">
      <p style="color:#3A5BD9;font-size:13px;font-weight:700;margin:0 0 12px;letter-spacing:0.08em">GET STARTED IN 3 STEPS</p>
    ...
    <div style="text-align:center;margin:32px 0">
      <a href="{{login_url}}" style="display:inline-block;background:linear-gradient(135deg,#3A5BD9,#5B7BF5);color:#04080F;font-weight:700;padding:16px 40px;border-radius:12px;text-decoration:none;font-size:15px;box-shadow:0 0 30px rgba(58,91,217,0.35)">Open My Vault →</a>
    </div>
  </div>
  <div style="background:rgba(0,0,0,0.3);padding:24px;text-align:center;border-top:1px solid rgba(58,91,217,0.1)">
    <p style="color:#4A5A7A;font-size:11px;margin:0">© 2026 Final Pass Down Inc. · <a href="#" style="color:#3A5BD9">Privacy</a> · <a href="#" style="color:#3A5BD9">Unsubscribe</a></p>
  </div>
</div>`,
  },
  {
    ...
    html: `<div style="font-family:'DM Sans',sans-serif;background:#04080F;color:#E8EDF5;max-width:600px;margin:0 auto;border-radius:16px;overflow:hidden;border:1px solid rgba(58,91,217,0.15)">
  <div style="background:linear-gradient(135deg,#060F1E,#0A1628);padding:32px;text-align:center;border-bottom:1px solid rgba(58,91,217,0.15)">
    <h1 style="color:#3A5BD9;font-size:20px;margin:0">Security Verification</h1>
  </div>
  <div style="padding:40px;text-align:center">
    <p style="color:#E8EDF5;font-size:16px">Hi <strong>{{user_name}}</strong>, your one-time code is:</p>
    <div style="background:rgba(58,91,217,0.08);border:2px solid rgba(58,91,217,0.4);border-radius:16px;padding:32px;margin:24px auto;display:inline-block;min-width:200px">
      <span style="font-family:monospace;font-size:42px;font-weight:700;color:#3A5BD9;letter-spacing:12px">{{otp_code}}</span>
    </div>
  ...
  <div style="padding:40px">
    ...
    <div style="text-align:center;margin:32px 0">
      <a href="{{reset_url}}" style="display:inline-block;background:rgba(58,91,217,0.15);color:#3A5BD9;font-weight:700;padding:16px 40px;border-radius:12px;text-decoration:none;font-size:15px;border:1px solid rgba(58,91,217,0.4)">Reset My Password</a>
    </div>
  ...
  <div style="padding:40px">
    ...
    <div style="background:rgba(0,0,0,0.3);border-radius:8px;overflow:hidden;height:12px;margin:20px 0">
      <div style="width:80%;height:100%;background:linear-gradient(90deg,#3A5BD9,#F6AD55);border-radius:8px"></div>
    </div>
  ...
  },
  {
    ...
    html: `<div style="font-family:'DM Sans',sans-serif;background:#04080F;color:#E8EDF5;max-width:600px;margin:0 auto;border-radius:16px;overflow:hidden;border:1px solid rgba(58,91,217,0.15)">
  <div style="background:#060F1E;padding:32px;border-bottom:1px solid rgba(58,91,217,0.1)">
  ...
  <div style="padding:40px">
    ...
    <div style="background:rgba(58,91,217,0.06);border:1px solid rgba(58,91,217,0.2);border-radius:12px;padding:24px;margin:24px 0">
      ...
      <div style="height:1px;background:rgba(58,91,217,0.15);margin:12px 0"></div>
      <div style="display:flex;justify-content:space-between">
        <span style="color:#E8EDF5;font-size:15px;font-weight:700">Total Charged</span><span style="color:#3A5BD9;font-size:18px;font-weight:700">{{overage_charge}}</span>
      </div>
    </div>
  ...
  <div style="background:linear-gradient(135deg,#060F1E,#0A1628);padding:40px;text-align:center;border-bottom:1px solid rgba(58,91,217,0.15)">
    ...
    <h1 style="color:#3A5BD9;font-size:22px;margin:12px 0">You're a Trusted Legacy Contact</h1>
  </div>
  <div style="padding:40px">
    <p style="color:#E8EDF5;font-size:16px">Dear <strong>{{contact_name}}</strong>,</p>
    <p style="color:#8AA3C8;font-size:14px;line-height:1.8"><strong style="color:#E8EDF5">{{owner_name}}</strong> has designated you as a <strong style="color:#3A5BD9">Legacy Contact</strong> on their Final Pass Down vault. This means you will receive access to their important documents and final wishes when the time comes.</p>
    <div style="background:rgba(58,91,217,0.08);border:1px solid rgba(58,91,217,0.2);border-radius:12px;padding:20px;margin:24px 0">
      <p style="color:#6B7FA8;font-size:12px;margin:0 0 6px;letter-spacing:0.08em">YOUR ACCESS LEVEL</p>
      <p style="color:#3A5BD9;font-size:15px;font-weight:600;margin:0">{{access_level}}</p>
    </div>
    ...
    <div style="text-align:center;margin:32px 0">
      <a href="{{verify_url}}" style="display:inline-block;background:linear-gradient(135deg,#3A5BD9,#5B7BF5);color:#04080F;font-weight:700;padding:16px 40px;border-radius:12px;text-decoration:none;font-size:15px;box-shadow:0 0 30px rgba(58,91,217,0.35)">Complete Verification →</a>
    </div>
  ...
  <div style="background:rgba(72,187,120,0.1);padding:40px;text-align:center;border-bottom:1px solid rgba(72,187,120,0.2)">
    ...
    <h1 style="color:#48BB78;font-size:22px;margin:12px 0">Identity Verified Successfully</h1>
  </div>
  <div style="padding:40px">
    ...
    <div style="background:rgba(72,187,120,0.08);border:1px solid rgba(72,187,120,0.2);border-radius:12px;padding:20px;margin:24px 0">
      <p style="color:#48BB78;font-size:13px;font-weight:700;margin:0 0 8px">ACCESS LEVEL: {{access_level}}</p>
  ...
  <div style="background:linear-gradient(135deg,#060F1E,#0A1628);padding:40px;text-align:center;border-bottom:1px solid rgba(58,91,217,0.15)">
    ...
    <h1 style="color:#3A5BD9;font-size:22px;margin:12px 0">You're Now an Affiliate!</h1>
  ...
  <div style="padding:40px">
    ...
    <div style="background:rgba(58,91,217,0.08);border:1px solid rgba(58,91,217,0.25);border-radius:12px;padding:20px;margin:24px 0">
      <p style="color:#6B7FA8;font-size:11px;margin:0 0 8px;letter-spacing:0.08em">YOUR REFERRAL LINK</p>
      <p style="color:#3A5BD9;font-size:14px;font-weight:700;font-family:monospace;word-break:break-all;margin:0">{{affiliate_link}}</p>
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px;margin:24px 0">
      <div style="background:rgba(0,0,0,0.3);border-radius:8px;padding:16px;text-align:center">
        <p style="color:#3A5BD9;font-size:24px;font-weight:700;margin:0">20%</p>
        <p style="color:#6B7FA8;font-size:11px;margin:4px 0 0">Tier 1: 5–24 refs</p>
      </div>
      <div style="background:rgba(58,91,217,0.08);border:1px solid rgba(58,91,217,0.2);border-radius:8px;padding:16px;text-align:center">
        <p style="color:#3A5BD9;font-size:24px;font-weight:700;margin:0">25%</p>
        <p style="color:#6B7FA8;font-size:11px;margin:4px 0 0">Tier 2: 25–74 refs</p>
      </div>
      <div style="background:rgba(0,0,0,0.3);border-radius:8px;padding:16px;text-align:center">
        <p style="color:#3A5BD9;font-size:24px;font-weight:700;margin:0">30%</p>
        <p style="color:#6B7FA8;font-size:11px;margin:4px 0 0">Tier 3: 74+ refs</p>
      </div>
    </div>
    <div style="text-align:center">
      <a href="{{dashboard_url}}" style="display:inline-block;background:linear-gradient(135deg,#3A5BD9,#5B7BF5);color:#04080F;font-weight:700;padding:14px 36px;border-radius:12px;text-decoration:none;font-size:14px">View My Dashboard →</a>
    </div>
  </div>
</div>`,
  },
  ...
  <div style="background:rgba(72,187,120,0.1);padding:40px;text-align:center;border-bottom:1px solid rgba(72,187,120,0.2)">
    <p style="font-size:36px;margin:0">🎉</p>
    <h1 style="color:#48BB78;font-size:22px;margin:12px 0">Commission Earned!</h1>
  </div>
  <div style="padding:40px;text-align:center">
    ...
    <div style="margin:32px auto">
      ...
      <p style="color:#48BB78;font-size:52px;font-weight:700;margin:8px 0;font-family:monospace">{{commission_amount}}</p>
    ...
    <a href="{{dashboard_url}}" style="display:inline-block;margin-top:24px;background:linear-gradient(135deg,#3A5BD9,#5B7BF5);color:#04080F;font-weight:700;padding:14px 36px;border-radius:12px;text-decoration:none;font-size:14px">View Earnings Dashboard</a>
  </div>
</div>`,
  },
  {
    ...
    html: `<div style="font-family:'DM Sans',sans-serif;background:#04080F;color:#E8EDF5;max-width:600px;margin:0 auto;border-radius:16px;overflow:hidden;border:1px solid rgba(58,91,217,0.25)">
  <div style="background:linear-gradient(135deg,#3A5BD9,#5B7BF5);padding:40px;text-align:center">
    <p style="font-size:40px;margin:0">🏆</p>
  ...
  <div style="padding:40px;text-align:center">
    <p style="color:#8AA3C8;font-size:14px">Hi <strong style="color:#E8EDF5">{{user_name}}</strong>, with <strong style="color:#3A5BD9">{{referrals_count}}</strong> active referrals, you've reached:</p>
    <div style="margin:32px auto">
      <p style="color:#6B7FA8;font-size:12px;letter-spacing:0.1em">NEW TIER</p>
      <p style="color:#3A5BD9;font-size:28px;font-weight:700;margin:8px 0">{{new_tier}}</p>
      <p style="color:#E8EDF5;font-size:52px;font-weight:900;color:#3A5BD9;margin:0;font-family:monospace">{{new_rate}}%</p>
  ...
  },
  {
    ...
    html: `<div style="font-family:'DM Sans',sans-serif;background:#04080F;color:#E8EDF5;max-width:600px;margin:0 auto;border-radius:16px;overflow:hidden;border:1px solid rgba(110,139,255,0.25)">
  <div style="background:linear-gradient(135deg,#1A0A3A,#2A1450);padding:40px;text-align:center;border-bottom:1px solid rgba(110,139,255,0.2)">
    <p style="font-size:36px;margin:0">🤝</p>
    <h1 style="color:#6E8BFF;font-size:22px;margin:12px 0">Strategic Partnership Activated</h1>
  ...
  <div style="padding:40px">
    ...
    <p style="color:#8AA3C8;font-size:14px;line-height:1.8">Your Strategic Partnership with Final Pass Down is now active. You will earn <strong style="color:#6E8BFF">recurring lifetime commissions</strong> on every account you refer — with no time cap and automatic tier upgrades as your network grows.</p>
    <div style="background:rgba(110,139,255,0.08);border:1px solid rgba(110,139,255,0.25);border-radius:12px;padding:20px;margin:24px 0">
      <p style="color:#6E8BFF;font-size:12px;font-weight:700;margin:0 0 6px;letter-spacing:0.08em">STARTING TIER: {{initial_tier}} — RECURRING LIFETIME</p>
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-top:12px">
        <div style="text-align:center;background:rgba(0,0,0,0.3);border-radius:8px;padding:12px">
          <p style="color:#6E8BFF;font-size:20px;font-weight:700;margin:0">20%</p>
          <p style="color:#6B7FA8;font-size:10px;margin:2px 0 0">0–50 accounts</p>
        </div>
        <div style="text-align:center;background:rgba(110,139,255,0.1);border:1px solid rgba(110,139,255,0.3);border-radius:8px;padding:12px">
          <p style="color:#6E8BFF;font-size:20px;font-weight:700;margin:0">25%</p>
          <p style="color:#6B7FA8;font-size:10px;margin:2px 0 0">51–100 accounts</p>
        </div>
        <div style="text-align:center;background:rgba(0,0,0,0.3);border-radius:8px;padding:12px">
          <p style="color:#6E8BFF;font-size:20px;font-weight:700;margin:0">30%</p>
          <p style="color:#6B7FA8;font-size:10px;margin:2px 0 0">101+ accounts</p>
        </div>
      </div>
    </div>
    <div style="text-align:center">
      <a href="{{dashboard_url}}" style="display:inline-block;background:linear-gradient(135deg,#6E8BFF,#B8C6F5);color:#04080F;font-weight:700;padding:14px 36px;border-radius:12px;text-decoration:none;font-size:14px;box-shadow:0 0 20px rgba(110,139,255,0.3)">Access Partner Dashboard →</a>
    </div>
  </div>
</div>`,
  },
  {
    ...
    html: `<div style="font-family:'DM Sans',sans-serif;background:#04080F;color:#E8EDF5;max-width:600px;margin:0 auto;border-radius:16px;overflow:hidden;border:1px solid rgba(110,139,255,0.3)">
  <div style="background:linear-gradient(135deg,#6E8BFF,#2E4BC7);padding:40px;text-align:center">
    <p style="font-size:36px;margin:0">🚀</p>
  ...
  <div style="padding:40px">
    ...
    <p style="color:#8AA3C8;font-size:14px;line-height:1.8">We've received your white label agreement. Your dedicated account manager <strong style="color:#E8EDF5">{{account_manager}}</strong> will reach out within 24 hours to begin the customization process. Estimated launch: <strong style="color:#6E8BFF">{{launch_date}}</strong>.</p>
    <div style="background:rgba(110,139,255,0.08);border:1px solid rgba(110,139,255,0.2);border-radius:12px;padding:24px;margin:24px 0">
      <p style="color:#6E8BFF;font-size:12px;font-weight:700;margin:0 0 12px;letter-spacing:0.08em">WHAT HAPPENS NEXT</p>
    ...
    <div style="text-align:center">
      <a href="{{setup_url}}" style="display:inline-block;background:linear-gradient(135deg,#6E8BFF,#B8C6F5);color:#04080F;font-weight:700;padding:14px 36px;border-radius:12px;text-decoration:none;font-size:14px">Begin Setup Portal →</a>
    </div>
  </div>
</div>`,
  },
  ...
  <div style="padding:40px">
    ...
    <div style="background:rgba(58,91,217,0.06);border:1px solid rgba(58,91,217,0.15);border-radius:12px;padding:24px;margin:24px 0">
      <div style="display:flex;justify-content:space-between;margin-bottom:12px">
      ...
      <div style="height:1px;background:rgba(58,91,217,0.1);margin:16px 0"></div>
      <div style="display:flex;justify-content:space-between">
        <span style="color:#E8EDF5;font-size:16px;font-weight:700">Total</span>
        <span style="color:#3A5BD9;font-size:20px;font-weight:700">{{amount}}</span>
      </div>
    </div>
    <div style="text-align:center">
      <a href="{{invoice_url}}" style="display:inline-block;background:rgba(58,91,217,0.1);color:#3A5BD9;font-weight:600;padding:12px 30px;border-radius:10px;text-decoration:none;font-size:13px;border:1px solid rgba(58,91,217,0.3)">Download Invoice</a>
    </div>
  </div>
</div>`,
  },
    ...
    <div className="p-6 space-y-5 relative" style={{ maxWidth: 1400, ...GRID }}>
      ...
      <div className="flex items-start justify-between">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <Mail size={15} color="#3A5BD9" />
            <span style={{ color: "#3A5BD9", fontSize: 11, ...MONO, letterSpacing: "0.12em" }}>ADMIN · EMAIL TEMPLATES</span>
          </div>
      ...
      <div className="grid" style={{ gridTemplateColumns: "300px 1fr", gap: 16, minHeight: 700 }}>
        ...
        <div className="rounded-2xl overflow-hidden flex flex-col glow-surface" style={GLASS}>
          {/* Search + filter */}
          <div className="p-3 border-b space-y-2" style={{ borderColor: "rgba(58,91,217,0.1)" }}>
            <div className="flex items-center gap-2 px-3 py-2 rounded-xl" style={{ background: "rgba(58,91,217,0.06)", border: "1px solid rgba(58,91,217,0.15)" }}>
            ...
            <div className="flex flex-wrap gap-1">
              {categories.map(cat => (
                <button key={cat} onClick={() => setActiveCategory(cat)}
                  ...
                  style={{ background: activeCategory === cat ? "#3A5BD9" : "rgba(58,91,217,0.06)", color: activeCategory === cat ? "#F0F4FA" : "#5A6A88", fontWeight: activeCategory === cat ? 700 : 400 }}>
                  {cat}
                </button>
              ))}
            </div>
          ...
          <div className="flex-1 overflow-y-auto" style={{ scrollbarWidth: "none" }}>
            {filtered.map(t => (
              <button key={t.id} onClick={() => handleSelect(t)}
                ...
                style={{ borderColor: "rgba(58,91,217,0.06)", background: selected?.id === t.id ? "rgba(58,91,217,0.1)" : "transparent", borderLeft: selected?.id === t.id ? "2px solid #3A5BD9" : "2px solid transparent" }}>
                <div className="flex items-center gap-2 mb-1">
                  <span className="px-2 py-0.5 rounded text-xs" style={{ background: "rgba(58,91,217,0.08)", color: "#3A5BD9", fontSize: 9, ...MONO }}>{t.category.toUpperCase()}</span>
                </div>
        ...
        {selected && (
          <div className="rounded-2xl overflow-hidden flex flex-col glow-surface" style={GLASS}>
            {/* Toolbar */}
            <div className="flex items-center justify-between px-5 py-3 border-b" style={{ borderColor: "rgba(58,91,217,0.1)", background: "rgba(3,7,16,0.6)" }}>
              <div>
              ...
              <div className="flex items-center gap-2">
                <button onClick={() => setPreviewMode(!previewMode)}
                  ...
                  style={{ background: previewMode ? "rgba(58,91,217,0.15)" : "rgba(58,91,217,0.06)", color: previewMode ? "#3A5BD9" : "#5A6A88", border: `1px solid ${previewMode ? "rgba(58,91,217,0.4)" : "rgba(58,91,217,0.15)"}` }}>
                ...
                {!editing ? (
                  <button onClick={() => setEditing(true)} className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm"
                    style={{ background: "rgba(58,91,217,0.08)", color: "#3A5BD9", border: "1px solid rgba(58,91,217,0.25)" }}>
                    <Edit2 size={13} /> Edit
                  </button>
                ) : (
                  <>
                    <button onClick={handleSave} className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm"
                      style={{ background: saved ? "rgba(72,187,120,0.15)" : "linear-gradient(135deg,#3A5BD9,#5B7BF5)", color: saved ? "#48BB78" : "#F0F4FA", fontWeight: 700 }}>
            ...
            {/* Variables */}
            <div className="px-5 py-2 border-b flex flex-wrap gap-2" style={{ borderColor: "rgba(58,91,217,0.06)", background: "rgba(58,91,217,0.04)" }}>
              ...
              {selected.variables.map(v => (
                <span key={v} className="px-2 py-0.5 rounded cursor-pointer" onClick={() => toast.info(`Variable: ${v}`)}
                  style={{ background: "rgba(58,91,217,0.08)", color: "#3A5BD9", fontSize: 10, ...MONO }}>
                  {v}
                </span>
              ))}
            </div>
            ...
            {/* Subject line */}
            <div className="px-5 py-3 border-b" style={{ borderColor: "rgba(58,91,217,0.08)" }}>
              <div style={{ color: "#8A9AB8", fontSize: 10, ...MONO, marginBottom: 6 }}>SUBJECT LINE</div>
              {editing ? (
                <input value={editSubject} onChange={e => setEditSubject(e.target.value)}
                  className="w-full px-3 py-2 rounded-xl" style={{ background: "rgba(58,91,217,0.06)", border: "1px solid rgba(58,91,217,0.25)", color: "#0D1428", fontSize: 14, outline: "none" }} />
              ) : (
