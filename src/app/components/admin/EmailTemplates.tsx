...
const templates: EmailTemplate[] = [
  ...
  },
  {
    ...
    html: `<div style="font-family:'DM Sans',sans-serif;background:#04080F;color:#E8EDF5;max-width:600px;margin:0 auto;border-radius:16px;overflow:hidden;border:1px solid rgba(159,122,234,0.25)">
  <div style="background:linear-gradient(135deg,#1A0A3A,#2A1450);padding:40px;text-align:center;border-bottom:1px solid rgba(159,122,234,0.2)">
    <p style="font-size:36px;margin:0">🤝</p>
    <h1 style="color:#9F7AEA;font-size:22px;margin:12px 0">Strategic Partnership Activated</h1>
  ...
  <div style="padding:40px">
    ...
    <p style="color:#8AA3C8;font-size:14px;line-height:1.8">Your Strategic Partnership with Final Pass Down is now active. You will earn <strong style="color:#9F7AEA">recurring lifetime commissions</strong> on every account you refer — with no time cap and automatic tier upgrades as your network grows.</p>
    <div style="background:rgba(159,122,234,0.08);border:1px solid rgba(159,122,234,0.25);border-radius:12px;padding:20px;margin:24px 0">
      <p style="color:#9F7AEA;font-size:12px;font-weight:700;margin:0 0 6px;letter-spacing:0.08em">STARTING TIER: {{initial_tier}} — RECURRING LIFETIME</p>
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-top:12px">
        <div style="text-align:center;background:rgba(0,0,0,0.3);border-radius:8px;padding:12px">
          <p style="color:#9F7AEA;font-size:20px;font-weight:700;margin:0">20%</p>
          <p style="color:#6B7FA8;font-size:10px;margin:2px 0 0">0–50 accounts</p>
        </div>
        <div style="text-align:center;background:rgba(159,122,234,0.1);border:1px solid rgba(159,122,234,0.3);border-radius:8px;padding:12px">
          <p style="color:#9F7AEA;font-size:20px;font-weight:700;margin:0">25%</p>
          <p style="color:#6B7FA8;font-size:10px;margin:2px 0 0">51–100 accounts</p>
        </div>
        <div style="text-align:center;background:rgba(0,0,0,0.3);border-radius:8px;padding:12px">
          <p style="color:#9F7AEA;font-size:20px;font-weight:700;margin:0">30%</p>
          <p style="color:#6B7FA8;font-size:10px;margin:2px 0 0">101+ accounts</p>
        </div>
      </div>
    </div>
    <div style="text-align:center">
      <a href="{{dashboard_url}}" style="display:inline-block;background:linear-gradient(135deg,#9F7AEA,#C4B5FD);color:#04080F;font-weight:700;padding:14px 36px;border-radius:12px;text-decoration:none;font-size:14px;box-shadow:0 0 20px rgba(159,122,234,0.3)">Access Partner Dashboard →</a>
    </div>
  </div>
</div>`,
  },
  {
    ...
    html: `<div style="font-family:'DM Sans',sans-serif;background:#04080F;color:#E8EDF5;max-width:600px;margin:0 auto;border-radius:16px;overflow:hidden;border:1px solid rgba(159,122,234,0.3)">
  <div style="background:linear-gradient(135deg,#9F7AEA,#7C3AED);padding:40px;text-align:center">
    <p style="font-size:36px;margin:0">🚀</p>
  ...
  <div style="padding:40px">
    ...
    <p style="color:#8AA3C8;font-size:14px;line-height:1.8">We've received your white label agreement. Your dedicated account manager <strong style="color:#E8EDF5">{{account_manager}}</strong> will reach out within 24 hours to begin the customization process. Estimated launch: <strong style="color:#9F7AEA">{{launch_date}}</strong>.</p>
    <div style="background:rgba(159,122,234,0.08);border:1px solid rgba(159,122,234,0.2);border-radius:12px;padding:24px;margin:24px 0">
      <p style="color:#9F7AEA;font-size:12px;font-weight:700;margin:0 0 12px;letter-spacing:0.08em">WHAT HAPPENS NEXT</p>
    ...
    <div style="text-align:center">
      <a href="{{setup_url}}" style="display:inline-block;background:linear-gradient(135deg,#9F7AEA,#C4B5FD);color:#04080F;font-weight:700;padding:14px 36px;border-radius:12px;text-decoration:none;font-size:14px">Begin Setup Portal →</a>
    </div>
  </div>
</div>`,
  },
