  ...
  return (
    <div className="p-6 space-y-6" style={{ maxWidth: 1100 }}>
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-2 px-4 py-2 rounded-lg" style={{ background: "rgba(246,173,85,0.1)", border: "1px solid rgba(246,173,85,0.3)" }}>
          ...
          <div key={verif.id} className="p-6 rounded-xl border" style={{ background: "var(--card)", borderColor: "var(--border)" }}>
            ...
            <div className="flex gap-4 mt-4">
              <div
                ...
                style={{ borderColor: "rgba(32,64,192,0.3)", background: "rgba(32,64,192,0.04)", borderStyle: "dashed" }}
