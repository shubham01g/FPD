...
/* cards */
.fpd-cal .card{background:linear-gradient(180deg,#0D1421 0%,#0A0F1A 100%);border:1px solid rgba(255,255,255,0.065);border-radius:15px;box-shadow:inset 0 1px 0 rgba(255,255,255,0.035),0 10px 34px -18px rgba(0,0,0,0.7);}
...
.fpd-cal .eyebrow{font-family:var(--font-mono);font-size:10px;letter-spacing:0.18em;text-transform:uppercase;color:${MUTED};display:flex;align-items:center;gap:7px;}
...
.fpd-cal .seg{display:flex;gap:3px;padding:3px;border-radius:10px;background:#0F1624;border:1px solid rgba(255,255,255,0.065);}
...
.fpd-cal .kcell{padding:20px 22px;border-left:1px solid rgba(255,255,255,0.065);position:relative;text-align:left;overflow:hidden;}
...
.fpd-cal .kcell .kico{width:27px;height:27px;border-radius:8px;border:1px solid rgba(255,255,255,0.065);display:flex;align-items:center;justify-content:center;background:#0F1624;color:${SOFT};}
...
@media (max-width:880px){.fpd-cal .kstrip{grid-template-columns:1fr 1fr;}.fpd-cal .kcell:nth-child(3){border-left:none;}.fpd-cal .kcell:nth-child(n+3){border-top:1px solid rgba(255,255,255,0.065);}}
...
.fpd-cal .chip{display:inline-flex;align-items:center;gap:7px;padding:7px 11px;border-radius:9px;font-size:12px;font-weight:600;cursor:pointer;font-family:var(--font-body);border:1px solid;transition:opacity .16s,background .16s,border-color .16s;}
...
/* month grid */
.fpd-cal .navbtn{width:32px;height:32px;border-radius:9px;display:inline-flex;align-items:center;justify-content:center;background:#0F1624;border:1px solid rgba(255,255,255,0.065);color:${SOFT};cursor:pointer;transition:border-color .18s,color .18s;}
...
.fpd-cal .cell{min-height:94px;padding:7px 7px 6px;border-radius:10px;border:1px solid rgba(255,255,255,0.05);background:rgba(255,255,255,0.012);display:flex;flex-direction:column;align-items:stretch;text-align:left;cursor:pointer;transition:border-color .16s,background .16s;overflow:hidden;}
...
.fpd-cal .evrow{display:flex;align-items:flex-start;gap:11px;padding:11px 12px;border-radius:11px;background:rgba(255,255,255,0.018);border:1px solid rgba(255,255,255,0.05);}
...
.fpd-cal .evopen{display:inline-flex;align-items:center;gap:4px;padding:6px 10px;border-radius:8px;font-size:11px;font-weight:600;flex-shrink:0;border:none;cursor:pointer;font-family:var(--font-body);transition:filter .18s;}
