    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 260 }}>
        <div className="flex items-center gap-2" style={{ marginBottom: 10 }}>
          ...
          />
          <span style={{ fontFamily: "var(--font-mono)", fontSize: 13.5, letterSpacing: "0.18em", color: statusColor, fontWeight: 700 }}>
            {sealed ? "SECURED & SEALED" : "SEALING IN PROGRESS"}
          </span>
        </div>

        <h2 style={{ fontFamily: "var(--font-display)", fontSize: 42.5, lineHeight: 1.12, color: TEXT, letterSpacing: "-0.02em", marginBottom: 8 }}>
          Vault {pct}% Prepared
        </h2>

        <p style={{ color: MUTED, fontSize: 17.5, lineHeight: 1.55, maxWidth: 420 }}>
          {sealed
          ...
          {items.map(item => (
            <button
              ...
              style={{
                ...
                color: item.done ? SOFT : MUTED, fontSize: 14.5,
              }}
            >
              <span
                style={{
        ...
        {!sealed && nextUp && (
          <button
            ...
            style={{
              ...
              color: "#fff", fontSize: 15.5, fontWeight: 650,
            }}
          >
