...
.fpd-travel .card{background:linear-gradient(180deg,#0D1421 0%,#0A0F1A 100%);border:1px solid rgba(255,255,255,0.22);border-radius:15px;box-shadow:inset 0 1px 0 rgba(255,255,255,0.035),0 10px 34px -18px rgba(0,0,0,0.7);}
...
.fpd-travel .btn-sec{display:inline-flex;align-items:center;gap:7px;padding:9px 15px;border-radius:9px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.22);color:${MUTED};font-size:12.5px;font-weight:600;cursor:pointer;font-family:var(--font-body);}

/* segmented status filter */
.fpd-travel .seg{display:flex;gap:3px;padding:3px;border-radius:12px;background:#0F1624;border:1px solid rgba(255,255,255,0.22);width:fit-content;}
...
.fpd-travel .kcell{padding:20px 22px;border-left:1px solid rgba(255,255,255,0.22);position:relative;text-align:left;overflow:hidden;}
...
.fpd-travel .kcell .kico{width:27px;height:27px;border-radius:8px;border:1px solid rgba(255,255,255,0.22);display:flex;align-items:center;justify-content:center;background:#0F1624;color:${SOFT};}
...
@media (max-width:880px){.fpd-travel .kstrip{grid-template-columns:1fr 1fr;}.fpd-travel .kcell:nth-child(3){border-left:none;}.fpd-travel .kcell:nth-child(n+3){border-top:1px solid rgba(255,255,255,0.22);}}
...
.fpd-travel .tbody{padding:0 20px 20px;border-top:1px solid rgba(255,255,255,0.22);}
.fpd-travel .tgrid{display:grid;grid-template-columns:1fr 1fr;border-radius:11px;background:#0F1624;border:1px solid rgba(255,255,255,0.22);overflow:hidden;margin-top:16px;}
.fpd-travel .tgrid .tile:nth-child(2n){border-left:1px solid rgba(255,255,255,0.22);}
.fpd-travel .tgrid .tile:nth-child(n+3){border-top:1px solid rgba(255,255,255,0.22);}
...
.fpd-travel .tgrid .tile:nth-child(n+2){border-top:1px solid rgba(255,255,255,0.22);}
}
...
.fpd-travel .modal-head{display:flex;align-items:center;justify-content:space-between;padding:18px 22px;border-bottom:1px solid rgba(255,255,255,0.22);}
...
.fpd-travel .field input,.fpd-travel .field select{width:100%;padding:11px 13px;border-radius:10px;background:#0F1624;border:1px solid rgba(255,255,255,0.22);color:${TEXT};font-size:13px;outline:none;font-family:var(--font-body);transition:border-color .18s,box-shadow .18s;}
...
.fpd-travel .modal-foot{display:flex;align-items:center;gap:10px;padding:16px 22px;border-top:1px solid rgba(255,255,255,0.22);}
