...
.fpd-ai .hd-eyebrow{font-size:10px;font-weight:600;color:${MUTED};}
.fpd-ai .hd-title{font-family:var(--font-display);font-size:15.5px;font-weight:600;color:${TEXT};letter-spacing:-0.01em;line-height:1.1;margin-top:2px;}
...
.fpd-ai .hd-status span{font-family:var(--font-mono);font-size:10.5px;color:${MUTED};letter-spacing:0.02em;}
...
.fpd-ai .eyebrow{font-size:11px;font-weight:600;color:${MUTED};display:flex;align-items:center;gap:7px;}
.fpd-ai .pg-h1{font-size:27px;color:${TEXT};font-weight:600;margin:9px 0 5px;letter-spacing:-0.02em;font-family:var(--font-display);}
.fpd-ai .pg-sub{color:${MUTED};font-size:14.5px;max-width:680px;line-height:1.6;}
...
.fpd-ai .hbanner h1{font-family:var(--font-display);font-size:32.5px;font-weight:700;line-height:1.14;letter-spacing:-0.02em;margin:0 0 10px;color:${TEXT};}
...
.fpd-ai .hbanner p{color:${SOFT};font-size:15px;line-height:1.6;max-width:400px;margin:0 0 20px;}
.fpd-ai .hbanner .hactions{display:flex;gap:10px;flex-wrap:wrap;}
.fpd-ai .hbanner .hbtn{display:inline-flex;align-items:center;gap:8px;padding:11px 18px;border-radius:99px;font-size:14px;font-weight:700;cursor:pointer;font-family:var(--font-body);border:none;transition:transform .18s,filter .18s;}
...
@media (max-width:640px){.fpd-ai .hbanner{min-height:auto;} .fpd-ai .hbanner .hcontent{padding:24px 22px;max-width:none;} .fpd-ai .hbanner h1{font-size:26px;}}
...
.fpd-ai .sec-title{font-size:15.5px;font-weight:600;color:${TEXT};display:flex;align-items:center;gap:10px;font-family:var(--font-display);letter-spacing:-0.01em;}
...
.fpd-ai .kpi-mini-val{font-family:var(--font-display);font-size:24.5px;font-weight:700;color:${TEXT};line-height:1.15;letter-spacing:-0.01em;font-variant-numeric:tabular-nums;}
.fpd-ai .kpi-mini-lbl{font-size:13px;color:${MUTED};margin-top:4px;}
.fpd-ai .kpi-mini-sub{font-size:12.5px;color:${SOFT};margin-top:5px;display:flex;align-items:center;gap:6px;}
...
.fpd-ai .chat-status{display:flex;align-items:center;gap:6px;font-family:var(--font-mono);font-size:11px;color:${MUTED};}
...
.fpd-ai .qrow .qtxt{flex:1;font-size:14px;color:${SOFT};font-weight:500;line-height:1.4;}
...
.fpd-ai .foot .ft{color:${MUTED};font-size:13.5px;line-height:1.7;}
...
.fpd-ai .bubble.user p{color:#fff;font-size:14.5px;line-height:1.55;}
.fpd-ai .btime{font-family:var(--font-mono);font-size:10px;margin-top:6px;text-align:right;}
.fpd-ai .bubble.user .btime{color:rgba(255,255,255,0.75);}
.fpd-ai .bubble.agent .btime{color:${FAINT};}

/* markdown atoms */
.fpd-ai .md-p{color:${SOFT};font-size:14.5px;line-height:1.7;margin:2px 0;font-family:var(--font-body);}
.fpd-ai .md-p strong{color:${TEXT};font-weight:600;}
.fpd-ai .md-eyebrow{font-size:10.5px;font-weight:600;color:${MUTED};margin:15px 0 7px;}
...
.fpd-ai .md-feat .ftext{font-size:14.5px;line-height:1.6;}
.fpd-ai .md-feat .fterm{color:${TEXT};font-weight:600;}
.fpd-ai .md-feat .fdesc{color:${MUTED};}
.fpd-ai .md-li{display:flex;align-items:flex-start;gap:9px;font-size:14.5px;color:${SOFT};line-height:1.6;margin:2px 0;font-family:var(--font-body);}
...
.fpd-ai .md-tr span{font-family:var(--font-mono);font-size:12.5px;min-width:64px;}
...
.fpd-ai .sugg .flabel{font-family:var(--font-mono);font-size:10px;letter-spacing:0.14em;color:${FAINT};align-self:center;flex-shrink:0;text-transform:uppercase;}
.fpd-ai .chip{white-space:nowrap;flex-shrink:0;padding:7px 13px;border-radius:99px;font-size:13.5px;font-weight:600;font-family:var(--font-body);cursor:pointer;color:#6FAE8B;background:rgba(91,110,225,0.10);border:1px solid rgba(91,110,225,0.28);transition:background .16s,border-color .16s;}
...
.fpd-ai .inbar input{flex:1;background:#0F1624;border:1px solid rgba(255,255,255,0.08);border-radius:16px;padding:10px 14px;font-size:14.5px;color:${TEXT};outline:none;font-family:var(--font-body);transition:border-color .18s,box-shadow .18s;}
