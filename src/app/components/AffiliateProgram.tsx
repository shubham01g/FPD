...
const tiers = [
  ...
  { tier: 2, label: "Tier 2", range: "25–74 accounts", rate: 25, color: "#3A5BD9" },
    ...
    <div className="p-6 space-y-6" style={{ maxWidth: 1100 }}>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          { label: "Pending Payout", value: `$${pendingPayout.toFixed(2)}`, sub: "Next payout: Jul 1", color: "#6E8BFF" },
        ].map((stat) => (
      ...
      <div className="p-6 rounded-xl border glow-surface" style={{ background: "var(--card)", borderColor: "var(--border)" }}>
        ...
        <div className="flex gap-3">
          <div
            ...
            style={{ background: "#141B2E", borderColor: "var(--border)" }}
          >
                ...
                return (
                  <div key={i} style={{ flex:1, display:"flex", flexDirection:"column", alignItems:"center", gap:4 }}>
                    ...
                    <div style={{ width:"100%", height:120, display:"flex", alignItems:"flex-end" }}>
                      <div style={{ width:"100%", height:h, background:"#3A5BD9", borderRadius:"4px 4px 0 0", opacity: i === monthlyEarnings.length-1 ? 1 : 0.55 }}/>
                    </div>
      ...
      <div className="rounded-xl border overflow-hidden" style={{ borderColor: "var(--border)" }}>
        ...
        <div>
          ...
          <div
            ...
            style={{ gridTemplateColumns: "1fr auto auto auto auto", background: "#141B2E", borderBottom: "1px solid var(--border)", gap: 16 }}
          >
          ...
          {referrals.map((ref, i) => (
            <div
              ...
              style={{ gridTemplateColumns: "1fr auto auto auto auto", background: i % 2 === 0 ? "#101728" : "#0F1A33", borderColor: "var(--border)", gap: 16 }}
            >
              <div>
