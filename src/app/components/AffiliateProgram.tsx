...
.fpd-aff .card{background:linear-gradient(180deg,#0D1421 0%,#0A0F1A 100%);border:1px solid rgba(255,255,255,0.065);border-radius:15px;box-shadow:inset 0 1px 0 rgba(255,255,255,0.035),0 10px 34px -18px rgba(0,0,0,0.7);}
...
.fpd-aff .tier-badge{display:flex;align-items:center;gap:12px;padding:16px 20px;border-radius:14px;flex:1;min-width:180px;border:1px solid rgba(255,255,255,0.065);background:linear-gradient(180deg,#0D1421 0%,#0A0F1A 100%);}
...
.fpd-aff .kcell{padding:20px 22px;border-left:1px solid rgba(255,255,255,0.065);position:relative;text-align:left;overflow:hidden;}
...
.fpd-aff .kcell .kico{width:27px;height:27px;border-radius:8px;border:1px solid rgba(255,255,255,0.065);display:flex;align-items:center;justify-content:center;background:#0F1624;color:${SOFT};}
...
@media (max-width:880px){.fpd-aff .kstrip{grid-template-columns:1fr 1fr;}.fpd-aff .kcell:nth-child(3){border-left:none;}.fpd-aff .kcell:nth-child(n+3){border-top:1px solid rgba(255,255,255,0.065);}}

/* referral link */
.fpd-aff .link-row{display:flex;gap:10px;flex-wrap:wrap;}
.fpd-aff .link-box{display:flex;align-items:center;gap:10px;flex:1;min-width:220px;padding:13px 16px;border-radius:12px;background:#0F1624;border:1px solid rgba(255,255,255,0.09);}
...
.fpd-aff .share-btn{display:flex;align-items:center;gap:7px;padding:9px 15px;border-radius:9px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.065);color:${TEXT};font-size:12.5px;cursor:pointer;font-family:var(--font-body);}
...
/* referral table */
.fpd-aff .table-hd{padding:14px 20px;border-bottom:1px solid rgba(255,255,255,0.065);}
...
.fpd-aff .trow.body{border-top:1px solid rgba(255,255,255,0.05);}
