...
.fpd-idk .hbanner h1{font-family:var(--font-display);font-size:29px;font-weight:700;line-height:1.14;letter-spacing:-0.02em;margin:0 0 10px;color:${TEXT};}
...
.fpd-idk .hbanner p{color:${SOFT};font-size:13.5px;line-height:1.6;max-width:400px;margin:0 0 20px;}
.fpd-idk .hbanner .hactions{display:flex;gap:10px;flex-wrap:wrap;}
.fpd-idk .hbanner .hbtn{display:inline-flex;align-items:center;gap:8px;padding:11px 18px;border-radius:99px;font-size:12.5px;font-weight:700;cursor:pointer;font-family:var(--font-body);border:none;transition:transform .18s,filter .18s;}
...
@media (max-width:640px){.fpd-idk .hbanner{min-height:auto;} .fpd-idk .hbanner .hcontent{padding:24px 22px;max-width:none;} .fpd-idk .hbanner h1{font-size:23px;}}

.fpd-idk .card{background:#101728;border:1px solid rgba(255,255,255,0.06);border-radius:22px;}
.fpd-idk .card.pad{padding:28px;}
.fpd-idk .eyebrow{font-size:10px;font-weight:600;color:${MUTED};display:flex;align-items:center;gap:7px;}
...
.fpd-idk .btn-sec{display:inline-flex;align-items:center;gap:7px;padding:9px 15px;border-radius:99px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);color:${MUTED};font-size:12.5px;font-weight:600;cursor:pointer;font-family:var(--font-body);}
...
.fpd-idk .kcell .klbl{font-size:9.5px;font-weight:600;color:${MUTED};}
...
.fpd-idk .chip{display:inline-flex;align-items:center;gap:7px;padding:7px 11px;border-radius:99px;font-size:12px;font-weight:600;cursor:pointer;font-family:var(--font-body);border:1px solid;transition:opacity .16s,background .16s,border-color .16s;}
...
.fpd-idk .iico{width:48px;height:48px;border-radius:16px;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:22px;}
...
.fpd-idk .idnum-lbl{font-size:9.5px;font-weight:600;color:${MUTED};margin-bottom:3px;}
...
.fpd-idk .field label{display:block;margin-bottom:6px;font-size:9.5px;font-weight:600;color:${MUTED};}
.fpd-idk .field input,.fpd-idk .field select{width:100%;padding:11px 13px;border-radius:18px;background:#0F1624;border:1px solid rgba(255,255,255,0.08);color:${TEXT};font-size:13px;outline:none;font-family:var(--font-body);transition:border-color .18s,box-shadow .18s;}
...
.fpd-idk .modal-foot .save{flex:1;padding:12px;border-radius:18px;font-size:13px;font-weight:700;border:none;cursor:pointer;background:linear-gradient(180deg,#7E6BD8,#5B6EE1);color:#fff;font-family:var(--font-body);transition:filter .18s;}
