...
.fpd-idk .hbanner h1{font-family:var(--font-display);font-size:32.5px;font-weight:700;line-height:1.14;letter-spacing:-0.02em;margin:0 0 10px;color:${TEXT};}
...
.fpd-idk .hbanner p{color:${SOFT};font-size:15px;line-height:1.6;max-width:400px;margin:0 0 20px;}
.fpd-idk .hbanner .hactions{display:flex;gap:10px;flex-wrap:wrap;}
.fpd-idk .hbanner .hbtn{display:inline-flex;align-items:center;gap:8px;padding:11px 18px;border-radius:99px;font-size:14px;font-weight:700;cursor:pointer;font-family:var(--font-body);border:none;transition:transform .18s,filter .18s;}
...
@media (max-width:640px){.fpd-idk .hbanner{min-height:auto;} .fpd-idk .hbanner .hcontent{padding:24px 22px;max-width:none;} .fpd-idk .hbanner h1{font-size:26px;}}

.fpd-idk .card{background:#101728;border:1px solid rgba(255,255,255,0.06);border-radius:22px;}
.fpd-idk .card.pad{padding:28px;}
.fpd-idk .eyebrow{font-size:11px;font-weight:600;color:${MUTED};display:flex;align-items:center;gap:7px;}

.fpd-idk .pg-head{display:flex;align-items:flex-end;justify-content:space-between;gap:20px;flex-wrap:wrap;}
.fpd-idk .pg-h1{font-size:27px;color:${TEXT};font-weight:600;margin:9px 0 5px;letter-spacing:-0.02em;font-family:var(--font-display);}
.fpd-idk .pg-sub{color:${MUTED};font-size:14.5px;max-width:660px;line-height:1.6;}
...
.fpd-idk .btn-sec{display:inline-flex;align-items:center;gap:7px;padding:9px 15px;border-radius:99px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);color:${MUTED};font-size:14px;font-weight:600;cursor:pointer;font-family:var(--font-body);}

/* KPI ledger */
.fpd-idk .kstrip{display:grid;grid-template-columns:repeat(4,1fr);border-radius:22px;}
.fpd-idk .kcell{padding:20px 22px;border-left:1px solid rgba(255,255,255,0.08);position:relative;text-align:left;overflow:hidden;}
...
.fpd-idk .kcell .klbl{font-size:10.5px;font-weight:600;color:${MUTED};}
.fpd-idk .kcell .kico{width:27px;height:27px;border-radius:16px;border:1px solid rgba(255,255,255,0.08);display:flex;align-items:center;justify-content:center;background:#0F1624;color:${SOFT};}
.fpd-idk .kcell .kval{font-family:var(--font-display);font-size:29px;font-weight:600;color:${TEXT};line-height:1;letter-spacing:-0.02em;font-variant-numeric:tabular-nums;}
.fpd-idk .kcell .ksub{font-size:13px;color:${MUTED};margin-top:9px;display:flex;align-items:center;gap:6px;}
.fpd-idk .kcell .ksub .dt{width:5px;height:5px;border-radius:50%;flex-shrink:0;}
@media (max-width:880px){.fpd-idk .kstrip{grid-template-columns:1fr 1fr;}.fpd-idk .kcell:nth-child(3){border-left:none;}.fpd-idk .kcell:nth-child(n+3){border-top:1px solid rgba(255,255,255,0.08);}}

/* filter chips */
.fpd-idk .filters{display:flex;align-items:center;gap:8px;flex-wrap:wrap;}
.fpd-idk .chip{display:inline-flex;align-items:center;gap:7px;padding:7px 11px;border-radius:99px;font-size:13.5px;font-weight:600;cursor:pointer;font-family:var(--font-body);border:1px solid;transition:opacity .16s,background .16s,border-color .16s;}
...
.fpd-idk .iico{width:48px;height:48px;border-radius:16px;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:24.5px;}
.fpd-idk .itype{color:${TEXT};font-size:15.5px;font-weight:600;}
.fpd-idk .iholder{color:${MUTED};font-size:13.5px;margin-top:1px;}
.fpd-idk .ibadge{display:inline-flex;align-items:center;padding:3px 8px;border-radius:99px;font-family:var(--font-mono);font-size:10.5px;font-weight:700;letter-spacing:0.03em;}
...
.fpd-idk .idnum-lbl{font-size:10.5px;font-weight:600;color:${MUTED};margin-bottom:3px;}
.fpd-idk .idnum-val{font-family:var(--font-mono);font-size:15.5px;font-weight:700;color:${TEXT};}
...
.fpd-idk .itile .tk{font-family:var(--font-mono);font-size:9.5px;letter-spacing:0.08em;color:${MUTED};margin-bottom:2px;}
.fpd-idk .itile .tv{color:${TEXT};font-size:13.5px;}
.fpd-idk .inotes{color:${MUTED};font-size:13.5px;line-height:1.55;}
...
.fpd-idk .modal-head h3{font-family:var(--font-display);font-size:18px;color:${TEXT};font-weight:600;}
...
.fpd-idk .scan-lbl{font-family:var(--font-mono);font-size:12px;letter-spacing:0.06em;color:${MUTED};margin-bottom:10px;font-weight:600;}
.fpd-idk .field label{display:block;margin-bottom:6px;font-size:10.5px;font-weight:600;color:${MUTED};}
.fpd-idk .field input,.fpd-idk .field select{width:100%;padding:11px 13px;border-radius:18px;background:#0F1624;border:1px solid rgba(255,255,255,0.08);color:${TEXT};font-size:14.5px;outline:none;font-family:var(--font-body);transition:border-color .18s,box-shadow .18s;}
...
.fpd-idk .modal-foot .save{flex:1;padding:12px;border-radius:18px;font-size:14.5px;font-weight:700;border:none;cursor:pointer;background:linear-gradient(180deg,#7E6BD8,#5B6EE1);color:#fff;font-family:var(--font-body);transition:filter .18s;}
