...
/* Folder taxonomy only. Every `files` array is intentionally empty: the
   cabinet's contents are the account's own uploads, read from
   DemoContext.docs (vault_documents) and merged in by docsForFolder below.
   These arrays used to ship sample documents — "Last Will & Testament",
   "1967 Mustang - Title", "Michael's Wedding 2022" - that every new user saw
   in their vault before uploading anything. */
