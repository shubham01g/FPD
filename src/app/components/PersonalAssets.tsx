...
.fpd-passets .hbanner h1{font-family:var(--font-display);font-size:32.5px;font-weight:700;line-height:1.14;letter-spacing:-0.02em;margin:0 0 10px;color:${TEXT};}
...
.fpd-passets .hbanner p{color:${SOFT};font-size:15px;line-height:1.6;max-width:400px;margin:0 0 20px;}
.fpd-passets .hbanner .hactions{display:flex;gap:10px;flex-wrap:wrap;}
.fpd-passets .hbanner .hbtn{display:inline-flex;align-items:center;gap:8px;padding:11px 18px;border-radius:99px;font-size:14px;font-weight:700;cursor:pointer;font-family:var(--font-body);border:none;transition:transform .18s,filter .18s;}
...
@media (max-width:640px){.fpd-passets .hbanner{min-height:auto;} .fpd-passets .hbanner .hcontent{padding:24px 22px;max-width:none;} .fpd-passets .hbanner h1{font-size:26px;}}
...
.fpd-passets .eyebrow{font-size:11px;font-weight:600;color:${MUTED};display:flex;align-items:center;gap:7px;}

/* header */
.fpd-passets .pg-h1{font-size:27px;color:${TEXT};font-weight:600;margin:9px 0 5px;letter-spacing:-0.02em;font-family:var(--font-display);}
.fpd-passets .pg-sub{color:${MUTED};font-size:14.5px;max-width:660px;line-height:1.6;}
...
.fpd-passets .btn-sec{display:inline-flex;align-items:center;gap:7px;padding:9px 15px;border-radius:99px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);color:${MUTED};font-size:14px;font-weight:600;cursor:pointer;font-family:var(--font-body);}
...
.fpd-passets .seg button{display:inline-flex;align-items:center;gap:7px;padding:9px 16px;border-radius:99px;font-size:14px;font-weight:600;color:${MUTED};background:none;border:none;cursor:pointer;font-family:var(--font-body);transition:color .18s,background .18s;}
...
/* alert banners */
.fpd-passets .banner{display:flex;align-items:flex-start;gap:10px;padding:13px 16px;border-radius:16px;font-size:14px;line-height:1.6;flex:1;min-width:220px;}
...
.fpd-passets .dtype{font-family:var(--font-display);font-size:19px;color:${TEXT};font-weight:600;margin-bottom:3px;letter-spacing:-0.01em;}
.fpd-passets .dsub{color:${MUTED};font-size:14px;}
.fpd-passets .dvalue{text-align:right;flex-shrink:0;}
.fpd-passets .dvnum{font-family:var(--font-display);font-size:21.5px;font-weight:700;color:#D99A6B;letter-spacing:-0.01em;line-height:1.2;}
.fpd-passets .dvlbl{color:${MUTED};font-size:12.5px;margin-top:2px;}
.fpd-passets .dright{display:flex;align-items:center;gap:10px;flex-shrink:0;}
.fpd-passets .damt{font-family:var(--font-mono);color:#6FAE8B;font-size:15.5px;font-weight:700;white-space:nowrap;}
.fpd-passets .damt span{color:${MUTED};font-weight:500;font-size:12.5px;}

.fpd-passets .dbadge{display:inline-flex;align-items:center;gap:6px;padding:5px 11px;border-radius:99px;font-family:var(--font-mono);font-size:11px;font-weight:700;letter-spacing:0.04em;flex-shrink:0;}
...
.fpd-passets .catbadge{display:inline-block;padding:3px 9px;border-radius:6px;font-family:var(--font-mono);font-size:11px;letter-spacing:0.04em;background:rgba(91,110,225,0.12);color:#6FAE8B;margin-bottom:9px;}
...
.fpd-passets .tile .tk{font-size:10.5px;font-weight:600;color:${MUTED};margin-bottom:5px;}
.fpd-passets .tile .tv{color:${TEXT};font-size:14.5px;line-height:1.5;}
...
.fpd-passets .notewarn{padding:12px 14px;border-radius:16px;background:rgba(217,165,94,0.08);border:1px solid rgba(217,165,94,0.22);color:${WARN};font-size:14px;line-height:1.6;margin-top:12px;}
.fpd-passets .noteinfo{padding:12px 14px;border-radius:16px;background:rgba(91,110,225,0.08);border:1px solid rgba(91,110,225,0.22);color:#6FAE8B;font-size:14px;line-height:1.6;margin-top:12px;}
.fpd-passets .notemuted{color:${MUTED};font-size:13.5px;margin-top:10px;line-height:1.6;}
.fpd-passets .noteitalic{color:${MUTED};font-size:13.5px;margin-top:10px;font-style:italic;line-height:1.6;}
...
.fpd-passets .photo-empty{display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:7px;color:${MUTED};font-size:13.5px;}
.fpd-passets .photo-btn{position:absolute;bottom:10px;right:10px;display:inline-flex;align-items:center;gap:6px;padding:7px 12px;border-radius:99px;background:rgba(5,8,14,0.65);backdrop-filter:blur(6px);color:#fff;font-size:13px;font-weight:600;border:none;cursor:pointer;font-family:var(--font-body);}
...
.fpd-passets .modal-head h3{font-family:var(--font-display);font-size:18px;color:${TEXT};font-weight:600;}
...
.fpd-passets .field label{display:block;margin-bottom:6px;font-size:10.5px;font-weight:600;color:${MUTED};}
.fpd-passets .field input,.fpd-passets .field select,.fpd-passets .field textarea{width:100%;padding:11px 13px;border-radius:18px;background:#0F1624;border:1px solid rgba(255,255,255,0.08);color:${TEXT};font-size:14.5px;outline:none;font-family:var(--font-body);transition:border-color .18s,box-shadow .18s;}
...
.fpd-passets .modal-foot .save{flex:1;padding:12px;border-radius:18px;font-size:14.5px;font-weight:700;border:none;cursor:pointer;background:linear-gradient(180deg,#7E6BD8,#5B6EE1);color:#fff;font-family:var(--font-body);transition:filter .18s;}
              ...
              <div key={u.id} className="card pad">
                <div className="dtop" style={{ marginBottom: 14 }}>
                  <div className="dleft">
                    ...
                    <div>
                      <div className="dtype" style={{ fontSize: 17 }}>{u.service}</div>
              ...
              <div key={d.id} className="card pad">
                <div className="dtop">
                  <div>
                    ...
                    <div className="dtype" style={{ fontSize: 18 }}>{d.asset}</div>
                    <div className="dsub">{d.platform}</div>
                  </div>
                  <div className="dvnum" style={{ fontSize: 17 }}>{d.value}</div>
                </div>
                ...
                <div className="pad" style={{ padding: 22 }}>
                  <div className="dtop">
                    <div>
                      ...
                      <div className="dtype" style={{ fontSize: 18 }}>{c.name}</div>
                    </div>
                    <div className="dvalue">
