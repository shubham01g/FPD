      ...
      <div className="max-w-lg mx-auto px-5 py-8 space-y-5">
        ...
        <div className="p-5 rounded-2xl"
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <span style={{ color:"#D68FA8", fontSize:15, fontWeight:700, fontFamily:"var(--font-mono)" }}>
              WHITE GLOVE CONCIERGE
            </span>
          </div>
          <div style={{ color:"#E8EDF5", fontSize:20, fontFamily:"var(--font-display)", marginBottom:6 }}>
            Hello, {clientName.split(" ")[0]}! 👋
          </div>
          <p style={{ color:"#8AA3C8", fontSize:16, lineHeight:1.7 }}>
          ...
          <div className="flex items-center gap-2 mt-3 px-3 py-2 rounded-2xl"
            ...
            <span style={{ color:"#D99A6B", fontSize:14 }}>
        ...
        {view === "submit" && (
          <div className="space-y-4">
            ...
            <div className="p-5 rounded-2xl" style={GLASS}>
              <div style={{ color:"#6FAE8B", fontSize:15, fontWeight:700, fontFamily:"var(--font-mono)", marginBottom:12 }}>
              ...
              {!selectedFile ? (
                <div className="space-y-3">
                  ...
                  />
                  <div style={{ textAlign:"center", color:"#8A9AB8", fontSize:15 }}>— or —</div>
                  ...
                  <p style={{ color:"#8A9AB8", fontSize:14, textAlign:"center", lineHeight:1.6 }}>
                  ...
                  <div className="relative rounded-2xl overflow-hidden"
                    ...
                    {previewUrl && selectedFile.type.includes("image") ? (
                      ...
                      <div className="flex items-center gap-3 px-4 py-5"
                        ...
                        <div>
                          <div style={{ color:"#E8EDF5", fontSize:16, fontWeight:500 }}>{selectedFile.name}</div>
                          <div style={{ color:"#8A9AB8", fontSize:14 }}>{selectedFile.type} · {Math.round(selectedFile.size/1024)}KB</div>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="absolute bottom-2 left-2 flex items-center gap-1 px-2 py-1 rounded-full"
                      ...
                      <span style={{ color:"#fff", fontSize:12.5, fontWeight:700 }}>Ready to send</span>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div className="mt-2 rounded-2xl overflow-hidden" style={{ border:"1px solid rgba(91,167,214,0.2)" }}>
                  {DOCUMENT_CATEGORIES.map(cat => (
                    <button key={cat.id} onClick={() => { setCategory(cat.id); setShowCategoryPicker(false); }}
                      ...
                      <span style={{ fontSize:25 }}>{cat.emoji}</span>
                      <span style={{ fontSize:17.5 }}>{cat.label}</span>
            ...
            <div className="p-5 rounded-2xl" style={GLASS}>
              ...
              <textarea value={notes} onChange={e => setNotes(e.target.value)} rows={3}
                ...
                style={{ background:"#141B2E", border:"1px solid rgba(91,167,214,0.3)", color:"#FFFFFF", fontSize:16, outline:"none" }}/>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <div key={s.label} className="p-3 rounded-2xl text-center"
                  ...
                  <div style={{ color:"#8A9AB8", fontSize:14 }}>{s.label}</div>
                </div>
              ))}
            </div>
            ...
            {submissions.length === 0 ? (
              <div className="py-12 text-center rounded-2xl"
                ...
                <div style={{ color:"#8A9AB8", fontSize:17.5 }}>No documents sent yet.</div>
                  ...
                  <div key={sub.id} className="p-4 rounded-2xl"
                    ...
                    <div className="flex items-start gap-3">
                      <div className="flex items-center justify-center rounded-2xl flex-shrink-0"
                        style={{ width:40, height:40, background:"rgba(91,167,214,0.08)", fontSize:25 }}>
                        {DOCUMENT_CATEGORIES.find(c=>sub.category.toLowerCase().includes(c.id))?.emoji ?? "📄"}
                      </div>
                      <div className="flex-1 min-w-0">
                        <div style={{ color:"#E8EDF5", fontSize:16, fontWeight:600, marginBottom:3 }}>{sub.category}</div>
                        <div style={{ color:"#8A9AB8", fontSize:14, marginBottom:6 }}>
                          {sub.fileName} · {sub.fileSizeMB} MB · {sub.submittedAt}
                        </div>
                        {sub.notes && <div style={{ color:"#8A9AB8", fontSize:15, fontStyle:"italic", marginBottom:6 }}>"{sub.notes}"</div>}
            ...
            <div className="p-4 rounded-2xl flex items-center gap-3"
              ...
              <div>
                <div style={{ color:"#E8EDF5", fontSize:16, fontWeight:500 }}>Need help sending documents?</div>
