...
.fpd-msg .hbanner h1{font-family:var(--font-display);font-size:36.5px;font-weight:700;line-height:1.14;letter-spacing:-0.02em;margin:0 0 10px;color:${TEXT};}
...
.fpd-msg .hbanner p{color:${SOFT};font-size:17px;line-height:1.6;max-width:400px;margin:0 0 20px;}
.fpd-msg .hbanner .hactions{display:flex;gap:10px;flex-wrap:wrap;}
.fpd-msg .hbanner .hbtn{display:inline-flex;align-items:center;gap:8px;padding:11px 18px;border-radius:99px;font-size:15.5px;font-weight:700;cursor:pointer;font-family:var(--font-body);border:none;transition:transform .18s,filter .18s;}
...
@media (max-width:640px){.fpd-msg .hbanner{min-height:auto;} .fpd-msg .hbanner .hcontent{padding:24px 22px;max-width:none;} .fpd-msg .hbanner h1{font-size:29px;}}

.fpd-msg .card{background:#101728;border:1px solid rgba(255,255,255,0.06);border-radius:22px;}
.fpd-msg .card.pad{padding:28px;}
.fpd-msg .eyebrow{font-size:12.5px;font-weight:600;color:${MUTED};display:flex;align-items:center;gap:7px;}
.fpd-msg .sec-title{display:flex;align-items:center;gap:9px;font-family:var(--font-display);font-size:17.5px;font-weight:600;color:${TEXT};margin-bottom:16px;}
...
.fpd-msg .pg-h1{font-size:30px;color:${TEXT};font-weight:600;margin:9px 0 5px;letter-spacing:-0.02em;font-family:var(--font-display);}
.fpd-msg .pg-sub{color:${MUTED};font-size:16px;max-width:640px;line-height:1.6;}
...
.fpd-msg .btn-sec{display:inline-flex;align-items:center;gap:7px;padding:9px 15px;border-radius:99px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);color:${MUTED};font-size:15.5px;font-weight:600;cursor:pointer;font-family:var(--font-body);}
...
.fpd-msg .kcell .klbl{font-size:12px;font-weight:600;color:${MUTED};}
...
.fpd-msg .kcell .kval{font-family:var(--font-display);font-size:32.5px;font-weight:600;color:${TEXT};line-height:1;letter-spacing:-0.02em;font-variant-numeric:tabular-nums;}
.fpd-msg .kcell .ksub{font-size:14.5px;color:${MUTED};margin-top:9px;display:flex;align-items:center;gap:6px;}
...
.fpd-msg .seg button{display:inline-flex;align-items:center;gap:7px;padding:9px 14px;border-radius:99px;font-size:15.5px;font-weight:600;color:${MUTED};background:none;border:none;cursor:pointer;font-family:var(--font-body);transition:color .18s,background .18s;}
...
.fpd-msg .seg .segcount{display:inline-flex;align-items:center;justify-content:center;min-width:18px;height:18px;padding:0 5px;border-radius:99px;background:rgba(255,255,255,0.1);font-family:var(--font-mono);font-size:12.5px;}
...
.fpd-msg .searchbar input{flex:1;background:transparent;border:none;outline:none;color:${TEXT};font-size:15.5px;font-family:var(--font-body);}
...
.fpd-msg .ravatar{width:30px;height:30px;border-radius:50%;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,${ACCENT},${ACCENT2});color:#fff;font-size:14px;font-weight:700;flex-shrink:0;}
.fpd-msg .rname{font-family:var(--font-display);font-size:19px;font-weight:600;color:${TEXT};}
.fpd-msg .rrel{color:${MUTED};font-size:15px;}
.fpd-msg .tag{display:inline-flex;align-items:center;gap:6px;padding:5px 11px;border-radius:99px;font-family:var(--font-mono);font-size:12.5px;font-weight:700;letter-spacing:0.04em;flex-shrink:0;}
...
.fpd-msg .mrow-title span.t{color:${TEXT};font-size:17.5px;font-weight:600;}
.fpd-msg .mrow-tags{display:flex;align-items:center;gap:6px;flex-wrap:wrap;}
.fpd-msg .mrow-preview{color:${MUTED};font-size:15px;margin-top:8px;line-height:1.6;overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;}
.fpd-msg .mrow-date{color:${FAINT};font-family:var(--font-mono);font-size:13.5px;flex-shrink:0;white-space:nowrap;}
...
.fpd-msg .mrow-text{padding:12px 14px;border-radius:18px;background:#0B111D;border:1px solid rgba(255,255,255,0.08);color:${SOFT};font-size:16px;line-height:1.85;white-space:pre-wrap;}
.fpd-msg .mrow-foot{display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;margin-top:12px;}
.fpd-msg .mrow-when{display:flex;align-items:center;gap:6px;color:${MUTED};font-size:14.5px;}
.fpd-msg .mrow-actions{display:flex;align-items:center;gap:8px;}
.fpd-msg .btn-ghost-sm{display:inline-flex;align-items:center;gap:6px;padding:8px 13px;border-radius:99px;font-size:15px;font-weight:600;cursor:pointer;font-family:var(--font-body);background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);}
...
.fpd-msg .sample-tag{font-family:var(--font-mono);font-size:12.5px;color:${MUTED};margin-top:3px;letter-spacing:0.04em;}
...
.fpd-msg .empty-title{color:${TEXT};font-size:19px;font-weight:600;}
.fpd-msg .empty-desc{color:${MUTED};font-size:15.5px;max-width:360px;line-height:1.6;margin-bottom:6px;}
...
.fpd-msg .rec-time{font-family:var(--font-mono);font-size:30px;font-weight:700;margin-bottom:4px;}
.fpd-msg .rec-status{color:${MUTED};font-size:14.5px;margin-bottom:14px;}
.fpd-msg .rec-btn{display:inline-flex;align-items:center;gap:8px;padding:10px 20px;border-radius:16px;font-size:16px;font-weight:600;border:none;cursor:pointer;font-family:var(--font-body);}
.fpd-msg .rec-hint{font-family:var(--font-mono);font-size:13.5px;margin-top:12px;}
...
.fpd-msg .rerecord{color:${NEG};font-size:15px;font-weight:600;background:none;border:none;cursor:pointer;font-family:var(--font-body);}

/* medium picker in compose modal */
.fpd-msg .medium-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;}
.fpd-msg .medium-btn{display:flex;flex-direction:column;align-items:center;gap:6px;padding:13px 8px;border-radius:16px;font-size:15.5px;font-weight:600;cursor:pointer;font-family:var(--font-body);background:#0F1624;border:1px solid rgba(255,255,255,0.08);color:${MUTED};transition:all .16s;}
.fpd-msg .word-count{font-family:var(--font-mono);font-size:13.5px;color:${FAINT};margin-top:5px;}
...
.fpd-msg .modal-head h3{font-family:var(--font-display);font-size:20px;color:${TEXT};font-weight:600;}
              ...
              {form.duration ? (
                <div className="rec-saved">
                  <div className="flex items-center gap-2">
                    ...
                    <span style={{ color: TEXT, fontSize: 16 }}>Recording captured — {form.duration}</span>
                  </div>
                              ...
                              <div className="mrow-media" style={{ borderColor: `${mm.color}33` }}>
                                {m.mediaUrl ? (
                                  ...
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div style={{ flex: 1 }}>
                                      <div style={{ color: TEXT, fontSize: 15.5 }}>
