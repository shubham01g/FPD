...
.fpd-msg .hbanner{position:relative;overflow:hidden;border-radius:22px;min-height:220px;display:flex;align-items:stretch;background:#0A0F1A;border:1px solid rgba(255,255,255,0.06);isolation:isolate;flex-shrink:0;}
.fpd-msg .hbanner .art{position:absolute;inset:-6%;z-index:0;transition:transform .7s cubic-bezier(.16,1,.3,1);transform:scale(1);pointer-events:none;background-size:cover;background-position:center;background-blend-mode:color;}
.fpd-msg .hbanner:hover .art{transform:scale(1.08);}
.fpd-msg .hbanner .scrim{position:absolute;inset:0;z-index:1;background:linear-gradient(100deg,#070A12 0%,rgba(7,10,18,0.94) 32%,rgba(7,10,18,0.58) 60%,rgba(7,10,18,0.18) 100%);pointer-events:none;}
.fpd-msg .hbanner .hcontent{position:relative;z-index:2;padding:30px 34px;display:flex;flex-direction:column;justify-content:center;max-width:480px;}
.fpd-msg .hbanner .heyebrow{display:inline-flex;align-items:center;gap:8px;align-self:flex-start;padding:6px 13px;border-radius:99px;background:rgba(91,110,225,0.14);border:1px solid rgba(91,110,225,0.36);color:#AEB9F5;font-size:11px;font-weight:700;letter-spacing:0.13em;text-transform:uppercase;margin-bottom:14px;font-family:var(--font-mono);}
.fpd-msg .hbanner h1{font-family:var(--font-display);font-size:32.5px;font-weight:700;line-height:1.14;letter-spacing:-0.02em;margin:0 0 10px;color:${TEXT};}
.fpd-msg .hbanner h1 .accent{background:linear-gradient(90deg,${ACCENT2},${ACCENT});-webkit-background-clip:text;background-clip:text;color:transparent;}
.fpd-msg .hbanner p{color:${SOFT};font-size:15px;line-height:1.6;max-width:400px;margin:0 0 20px;}
.fpd-msg .hbanner .hactions{display:flex;gap:10px;flex-wrap:wrap;}
.fpd-msg .hbanner .hbtn{display:inline-flex;align-items:center;gap:8px;padding:11px 18px;border-radius:99px;font-size:14px;font-weight:700;cursor:pointer;font-family:var(--font-body);border:none;transition:transform .18s,filter .18s;}
.fpd-msg .hbanner .hbtn:hover{transform:translateY(-1px);}
.fpd-msg .hbanner .hbtn.primary{background:linear-gradient(180deg,#7E6BD8,${ACCENT});color:#fff;box-shadow:0 14px 30px -12px rgba(91,110,225,0.75),inset 0 1px 0 rgba(255,255,255,0.18);}
.fpd-msg .hbanner .hbtn.ghost{background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.16);color:#fff;}
.fpd-msg .hbanner .hbtn.ghost:hover{background:rgba(255,255,255,0.1);}
@media (max-width:640px){.fpd-msg .hbanner{min-height:auto;} .fpd-msg .hbanner .hcontent{padding:24px 22px;max-width:none;} .fpd-msg .hbanner h1{font-size:26px;}}

.fpd-msg .card{background:#101728;border:1px solid rgba(255,255,255,0.06);border-radius:22px;}
.fpd-msg .card.pad{padding:28px;}
.fpd-msg .eyebrow{font-size:11px;font-weight:600;color:${MUTED};display:flex;align-items:center;gap:7px;}
.fpd-msg .sec-title{display:flex;align-items:center;gap:9px;font-family:var(--font-display);font-size:15.5px;font-weight:600;color:${TEXT};margin-bottom:16px;}
...
.fpd-msg .pg-h1{font-size:27px;color:${TEXT};font-weight:600;margin:9px 0 5px;letter-spacing:-0.02em;font-family:var(--font-display);}
.fpd-msg .pg-sub{color:${MUTED};font-size:14.5px;max-width:640px;line-height:1.6;}
.fpd-msg .btn-primary{display:inline-flex;align-items:center;gap:8px;padding:10px 17px;border-radius:99px;background:linear-gradient(180deg,#7E6BD8,#5B6EE1);color:#fff;font-size:14px;font-weight:600;box-shadow:0 8px 20px -8px rgba(91,110,225,0.7),inset 0 1px 0 rgba(255,255,255,0.035);transition:filter .18s,transform .18s;border:none;cursor:pointer;font-family:var(--font-body);flex-shrink:0;}
.fpd-msg .btn-primary:hover{filter:brightness(1.08);transform:translateY(-1px);}
.fpd-msg .btn-sec{display:inline-flex;align-items:center;gap:7px;padding:9px 15px;border-radius:99px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);color:${MUTED};font-size:14px;font-weight:600;cursor:pointer;font-family:var(--font-body);}

/* KPI ledger */
.fpd-msg .kstrip{display:grid;grid-template-columns:repeat(4,1fr);border-radius:22px;}
.fpd-msg .kcell{padding:20px 22px;border-left:1px solid rgba(255,255,255,0.08);position:relative;text-align:left;overflow:hidden;}
...
.fpd-msg .kcell .klbl{font-size:10.5px;font-weight:600;color:${MUTED};}
.fpd-msg .kcell .kico{width:27px;height:27px;border-radius:16px;border:1px solid rgba(255,255,255,0.08);display:flex;align-items:center;justify-content:center;background:#0F1624;color:${SOFT};}
.fpd-msg .kcell .kval{font-family:var(--font-display);font-size:29px;font-weight:600;color:${TEXT};line-height:1;letter-spacing:-0.02em;font-variant-numeric:tabular-nums;}
.fpd-msg .kcell .ksub{font-size:13px;color:${MUTED};margin-top:9px;display:flex;align-items:center;gap:6px;}
.fpd-msg .kcell .ksub .dt{width:5px;height:5px;border-radius:50%;flex-shrink:0;}
@media (max-width:880px){.fpd-msg .kstrip{grid-template-columns:1fr 1fr;}.fpd-msg .kcell:nth-child(3){border-left:none;}.fpd-msg .kcell:nth-child(n+3){border-top:1px solid rgba(255,255,255,0.08);}}
...
.fpd-msg .seg button{display:inline-flex;align-items:center;gap:7px;padding:9px 14px;border-radius:99px;font-size:14px;font-weight:600;color:${MUTED};background:none;border:none;cursor:pointer;font-family:var(--font-body);transition:color .18s,background .18s;}
...
.fpd-msg .seg .segcount{display:inline-flex;align-items:center;justify-content:center;min-width:18px;height:18px;padding:0 5px;border-radius:99px;background:rgba(255,255,255,0.1);font-family:var(--font-mono);font-size:11px;}
.fpd-msg .seg button.on .segcount{background:rgba(255,255,255,0.25);}
.fpd-msg .searchbar{display:flex;align-items:center;gap:9px;padding:0 13px;height:40px;min-width:240px;border-radius:99px;background:#0F1624;border:1px solid rgba(255,255,255,0.08);color:${FAINT};transition:border-color .18s,box-shadow .18s;}
.fpd-msg .searchbar:focus-within{border-color:rgba(91,110,225,0.5);box-shadow:0 0 0 3px rgba(91,110,225,0.12);}
.fpd-msg .searchbar input{flex:1;background:transparent;border:none;outline:none;color:${TEXT};font-size:14px;font-family:var(--font-body);}
...
.fpd-msg .ravatar{width:30px;height:30px;border-radius:50%;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,${ACCENT},${ACCENT2});color:#fff;font-size:12.5px;font-weight:700;flex-shrink:0;}
.fpd-msg .rname{font-family:var(--font-display);font-size:17px;font-weight:600;color:${TEXT};}
.fpd-msg .rrel{color:${MUTED};font-size:13.5px;}
.fpd-msg .tag{display:inline-flex;align-items:center;gap:6px;padding:5px 11px;border-radius:99px;font-family:var(--font-mono);font-size:11px;font-weight:700;letter-spacing:0.04em;flex-shrink:0;}

/* message rows */
.fpd-msg .mrows{display:flex;flex-direction:column;gap:10px;}
.fpd-msg .mrow{border-radius:16px;background:#0F1624;border:1px solid rgba(255,255,255,0.08);transition:border-color .18s;}
...
.fpd-msg .mrow-ico{width:36px;height:36px;border-radius:18px;flex-shrink:0;display:flex;align-items:center;justify-content:center;}
.fpd-msg .mrow-title{display:flex;align-items:center;gap:7px;flex-wrap:wrap;margin-bottom:6px;}
.fpd-msg .mrow-title span.t{color:${TEXT};font-size:15.5px;font-weight:600;}
.fpd-msg .mrow-tags{display:flex;align-items:center;gap:6px;flex-wrap:wrap;}
.fpd-msg .mrow-preview{color:${MUTED};font-size:13.5px;margin-top:8px;line-height:1.6;overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;}
.fpd-msg .mrow-date{color:${FAINT};font-family:var(--font-mono);font-size:12px;flex-shrink:0;white-space:nowrap;}
.fpd-msg .mrow-body{padding:0 16px 16px;border-top:1px solid rgba(255,255,255,0.08);margin-top:2px;padding-top:14px;}
.fpd-msg .mrow-media{padding:12px 14px;border-radius:18px;background:#0B111D;border:1px solid rgba(255,255,255,0.08);margin-bottom:12px;}
.fpd-msg .mrow-text{padding:12px 14px;border-radius:18px;background:#0B111D;border:1px solid rgba(255,255,255,0.08);color:${SOFT};font-size:14.5px;line-height:1.85;white-space:pre-wrap;}
.fpd-msg .mrow-foot{display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;margin-top:12px;}
.fpd-msg .mrow-when{display:flex;align-items:center;gap:6px;color:${MUTED};font-size:13px;}
.fpd-msg .mrow-actions{display:flex;align-items:center;gap:8px;}
.fpd-msg .btn-ghost-sm{display:inline-flex;align-items:center;gap:6px;padding:8px 13px;border-radius:99px;font-size:13.5px;font-weight:600;cursor:pointer;font-family:var(--font-body);background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);}
.fpd-msg .btn-del{width:36px;height:36px;border-radius:18px;background:rgba(208,107,107,0.1);color:${NEG};border:1px solid rgba(208,107,107,0.2);display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0;}
.fpd-msg .sample-tag{font-family:var(--font-mono);font-size:11px;color:${MUTED};margin-top:3px;letter-spacing:0.04em;}

/* empty state */
.fpd-msg .empty{display:flex;flex-direction:column;align-items:center;text-align:center;padding:54px 24px;gap:8px;}
.fpd-msg .empty-ico{width:52px;height:52px;border-radius:18px;background:rgba(91,110,225,0.10);border:1px solid rgba(91,110,225,0.24);color:#FFFFFF;display:flex;align-items:center;justify-content:center;margin-bottom:8px;}
.fpd-msg .empty-title{color:${TEXT};font-size:17px;font-weight:600;}
.fpd-msg .empty-desc{color:${MUTED};font-size:14px;max-width:360px;line-height:1.6;margin-bottom:6px;}
...
.fpd-msg .note .nt-title{color:${TEXT};font-size:14.5px;font-weight:600;margin-bottom:3px;}
.fpd-msg .note .nt-desc{color:${MUTED};font-size:13px;line-height:1.6;}

/* recorder panel */
.fpd-msg .rec-panel{border-radius:18px;background:#0F1624;border:1px solid rgba(255,255,255,0.08);padding:20px;text-align:center;}
.fpd-msg .rec-video{width:100%;max-height:200px;border-radius:16px;background:#0B111D;margin-bottom:12px;object-fit:cover;}
...
.fpd-msg .rec-time{font-family:var(--font-mono);font-size:27px;font-weight:700;margin-bottom:4px;}
.fpd-msg .rec-status{color:${MUTED};font-size:13px;margin-bottom:14px;}
.fpd-msg .rec-btn{display:inline-flex;align-items:center;gap:8px;padding:10px 20px;border-radius:16px;font-size:14.5px;font-weight:600;border:none;cursor:pointer;font-family:var(--font-body);}
.fpd-msg .rec-hint{font-family:var(--font-mono);font-size:12px;margin-top:12px;}
.fpd-msg .rec-saved{display:flex;align-items:center;justify-content:space-between;padding:12px 14px;border-radius:16px;background:#0F1624;border:1px solid rgba(95,190,145,0.3);}
.fpd-msg .rerecord{color:${NEG};font-size:13.5px;font-weight:600;background:none;border:none;cursor:pointer;font-family:var(--font-body);}

/* medium picker in compose modal */
.fpd-msg .medium-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;}
.fpd-msg .medium-btn{display:flex;flex-direction:column;align-items:center;gap:6px;padding:13px 8px;border-radius:16px;font-size:14px;font-weight:600;cursor:pointer;font-family:var(--font-body);background:#0F1624;border:1px solid rgba(255,255,255,0.08);color:${MUTED};transition:all .16s;}
.fpd-msg .word-count{font-family:var(--font-mono);font-size:12px;color:${FAINT};margin-top:5px;}
...
.fpd-msg .modal-head{display:flex;align-items:center;justify-content:space-between;padding:18px 22px;border-bottom:1px solid rgba(255,255,255,0.08);}
.fpd-msg .modal-head h3{font-family:var(--font-display);font-size:18px;color:${TEXT};font-weight:600;}
...
.fpd-msg .field label{display:block;margin-bottom:6px;font-size:10.5px;font-weight:600;color:${MUTED};}
.fpd-msg .field input,.fpd-msg .field select,.fpd-msg .field textarea{width:100%;padding:11px 13px;border-radius:18px;background:#0F1624;border:1px solid rgba(255,255,255,0.08);color:${TEXT};font-size:14.5px;outline:none;font-family:var(--font-body);transition:border-color .18s,box-shadow .18s;}
...
.fpd-msg .save{display:inline-flex;align-items:center;gap:8px;padding:10px 18px;border-radius:18px;font-size:14.5px;font-weight:700;border:none;cursor:pointer;background:linear-gradient(180deg,#7E6BD8,#5B6EE1);color:#fff;font-family:var(--font-body);transition:filter .18s;}
              ...
              {form.duration ? (
                <div className="rec-saved">
                  <div className="flex items-center gap-2">
                    ...
                    <span style={{ color: TEXT, fontSize: 14.5 }}>Recording captured — {form.duration}</span>
                  </div>
    ...
    <div className="fpd-msg">
      ...
      <div className="wrap">
        ...
        <div className="hbanner">
          <div className="art" style={{ backgroundImage: `linear-gradient(160deg, rgba(91,110,225,0.38), rgba(91,167,214,0.2)), url(${heroMessagesPhoto})` }} />
          <div className="scrim" />
          <div className="hcontent">
            <span className="heyebrow">Words They'll Keep Forever</span>
            <h1>Say what needs saying — <span className="accent">delivered exactly when it should be.</span></h1>
            <p>Letters, voice notes, and videos addressed to the people you love, sealed and delivered on your terms — after your passing, on a date, or every birthday.</p>
            <div className="hactions">
              <button className="hbtn primary" onClick={() => { setEditing(null); setComposing(true); }}>
                <Pencil size={15}/> Write a Message
              </button>
              <button className="hbtn ghost" onClick={() => messagesRef.current?.scrollIntoView({ behavior: "smooth", block: "start" })}>
                <Heart size={15}/> View All Messages
              </button>
            </div>
          </div>
        </div>
        ...
        {byRecipient.length === 0 ? (
          ...
          <div className="dlist" style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {byRecipient.map(([recipient, msgs]) => (
              <div key={recipient} className="card pad">
