  ...
  return (
    <div className="min-h-screen flex" style={{ background:"#04080F", fontFamily:"var(--font-body)" }}>
      ...
      <div className="hidden lg:flex flex-col justify-between w-5/12 p-12 relative overflow-hidden"
        style={{ background:"linear-gradient(145deg,#0A0F2E 0%,#030710 100%)", borderRight:"1px solid rgba(159,122,234,0.12)" }}>
        {/* Grid */}
        <div className="absolute inset-0" style={{ backgroundImage:"linear-gradient(rgba(159,122,234,0.03) 1px,transparent 1px),linear-gradient(90deg,rgba(159,122,234,0.03) 1px,transparent 1px)", backgroundSize:"50px 50px" }}/>
        {/* Orbs */}
        ...
        <div style={{ position:"absolute", bottom:"10%", right:"0%", width:260, height:260, borderRadius:"50%", background:"radial-gradient(circle,rgba(159,122,234,0.08) 0%,transparent 70%)", pointerEvents:"none" }}/>

        <div className="relative">
          <div className="flex items-center gap-3 mb-16">
            <img src={fpdSquareLogo} alt="FPD" style={{ width:40, height:40, borderRadius:10, objectFit:"cover", boxShadow:"0 0 20px rgba(159,122,234,0.25)" }}/>
            <div>
              <div style={{ ...DISPLAY, color:"#C4B5FD", fontSize:12, fontWeight:700, letterSpacing:"0.06em" }}>FINAL PASS DOWN</div>
              <div style={{ color:"#4A3A6A", fontSize:9, letterSpacing:"0.15em", ...MONO }}>CONCIERGE STAFF PORTAL</div>
            </div>
          </div>
          ...
          <h1 style={{ ...DISPLAY, fontSize:"clamp(1.8rem,3.5vw,2.6rem)", color:"#E8EDF5", lineHeight:1.15, marginBottom:16 }}>
            White Glove<br /><span style={{ color:"#C4B5FD" }}>Concierge Portal</span>
          </h1>
        ...
        <div className="relative space-y-3">
          {[
            ...
            <div key={item.label} className="flex items-center gap-3 px-4 py-3 rounded-xl"
              style={{ background:"rgba(159,122,234,0.05)", border:"1px solid rgba(159,122,234,0.12)" }}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-3 mb-10 lg:hidden">
            ...
            <div style={{ ...DISPLAY, color:"#C4B5FD", fontSize:12, fontWeight:700, letterSpacing:"0.06em" }}>CONCIERGE PORTAL</div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading}
              ...
              style={{ background:"linear-gradient(135deg,#9F7AEA,#C4B5FD)", color:"#04080F",
                boxShadow:"0 0 28px rgba(159,122,234,0.4)", opacity:loading ? 0.7 : 1 }}>
