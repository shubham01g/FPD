...
.fpd-vclone .btn-close{width:100%;padding:13px;border-radius:16px;font-size:13px;font-weight:600;background:rgba(91,110,225,0.10);color:#6FAE8B;border:1px solid rgba(91,110,225,0.24);cursor:pointer;font-family:var(--font-body);}
...
.fpd-vclone .btn-primary{width:100%;padding:15px;border-radius:16px;font-weight:700;font-size:14.5px;color:#fff;border:none;cursor:pointer;background:linear-gradient(135deg,#5B6EE1,#5B6EE1);box-shadow:0 8px 26px -8px rgba(91,110,225,0.55);font-family:var(--font-body);}
...
.fpd-vclone .btn-back{flex:1;padding:13px;border-radius:16px;font-size:13px;background:rgba(91,110,225,0.08);color:#6FAE8B;border:1px solid rgba(91,110,225,0.22);cursor:pointer;font-family:var(--font-body);}
...
.fpd-vclone .btn-save{flex:1;display:flex;align-items:center;justify-content:center;gap:8px;padding:14px;border-radius:16px;font-weight:700;font-size:13px;color:#fff;border:none;cursor:pointer;background:linear-gradient(135deg,#5B6EE1,#5B6EE1);box-shadow:0 8px 20px -8px rgba(91,110,225,0.5);font-family:var(--font-body);}
`;
