...
.fpd-wl .eyebrow{font-size:10px;font-weight:600;color:${MUTED};display:flex;align-items:center;gap:7px;}
...
.fpd-wl .btn-ghost{display:inline-flex;align-items:center;gap:6px;padding:9px 15px;border-radius:16px;font-size:13px;cursor:pointer;font-family:var(--font-body);border:1px solid;background:none;}
.fpd-wl .btn-primary{display:inline-flex;align-items:center;gap:6px;padding:9px 20px;border-radius:16px;font-size:13px;font-weight:700;color:#fff;border:none;cursor:pointer;background:linear-gradient(180deg,#7E6BD8,#5B6EE1);box-shadow:0 6px 18px -8px rgba(91,110,225,0.7);font-family:var(--font-body);}
...
.fpd-wl-seg button{display:inline-flex;align-items:center;gap:6px;padding:9px 15px;border-radius:99px;font-size:13px;color:${MUTED};background:none;border:none;cursor:pointer;font-family:var(--font-body);}
...
/* fields */
.fpd-wl .field label{display:block;margin-bottom:6px;font-size:9.5px;font-weight:600;color:${MUTED};}
.fpd-wl .field input{width:100%;padding:11px 14px;border-radius:16px;background:#0F1624;border:1px solid rgba(255,255,255,0.08);color:${TEXT};font-size:14px;outline:none;font-family:var(--font-body);}
...
.fpd-wl .plan-input{width:100%;padding:11px 14px;border-radius:16px;margin-bottom:10px;outline:none;font-family:var(--font-display);font-size:17px;font-weight:700;color:${TEXT};}
...
.fpd-wl .plan-tag{padding:8px 14px;border-radius:16px;font-size:13px;}
...
.fpd-wl .warn-box{padding:12px 14px;border-radius:16px;background:rgba(217,165,94,0.08);border:1px solid rgba(217,165,94,0.24);color:${WARN};font-size:12px;}
