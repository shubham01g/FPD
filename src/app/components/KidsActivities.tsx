...
.fpd-kids .card{background:linear-gradient(180deg,#0D1421 0%,#0A0F1A 100%);border:1px solid rgba(255,255,255,0.22);border-radius:15px;box-shadow:inset 0 1px 0 rgba(255,255,255,0.035),0 10px 34px -18px rgba(0,0,0,0.7);}
...
.fpd-kids .kcell{padding:20px 22px;border-left:1px solid rgba(255,255,255,0.22);position:relative;text-align:left;overflow:hidden;}
...
.fpd-kids .kcell .kico{width:27px;height:27px;border-radius:8px;border:1px solid rgba(255,255,255,0.22);display:flex;align-items:center;justify-content:center;background:#0F1624;color:${SOFT};}
...
@media (max-width:700px){.fpd-kids .kstrip{grid-template-columns:1fr;}.fpd-kids .kcell{border-left:none;border-top:1px solid rgba(255,255,255,0.22);}.fpd-kids .kcell:first-child{border-top:none;}}
...
.fpd-kids .abody{border-top:1px solid rgba(255,255,255,0.22);padding:18px 22px 22px;display:flex;flex-direction:column;gap:14px;}

/* info tile grid */
.fpd-kids .igrid{display:grid;grid-template-columns:1fr 1fr;border-radius:11px;background:#0F1624;border:1px solid rgba(255,255,255,0.22);overflow:hidden;}
.fpd-kids .igrid .tile:nth-child(2n){border-left:1px solid rgba(255,255,255,0.22);}
.fpd-kids .igrid .tile:nth-child(n+3){border-top:1px solid rgba(255,255,255,0.22);}
@media (max-width:760px){
.fpd-kids .igrid{grid-template-columns:1fr;}
.fpd-kids .igrid .tile:nth-child(2n){border-left:none;}
.fpd-kids .igrid .tile:nth-child(n+2){border-top:1px solid rgba(255,255,255,0.22);}
}
...
.fpd-kids .modal-head{display:flex;align-items:center;justify-content:space-between;padding:18px 22px;border-bottom:1px solid rgba(255,255,255,0.22);}
