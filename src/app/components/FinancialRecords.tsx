...
export function FinancialRecords() {
  ...
  const Field = ({ label, value }: { label: string; value: string }) => (
    <div className="flex flex-col gap-1 px-4 py-3 rounded-lg" style={{ background: "#141B2E" }}>
        ...
        <div className="space-y-4">
          ...
          {retirement.map(r => (
            <Card key={r.id}>
              <div className="flex items-start justify-between mb-4">
                <div>
                  <span className="px-2 py-0.5 rounded text-xs mb-2 inline-block" style={{ background: "rgba(58,91,217,0.1)", color: "var(--primary)", fontFamily: "var(--font-mono)" }}>{r.type}</span>
                ...
                <div style={{ color: "#6E8BFF", fontFamily: "var(--font-display)", fontSize: 20, fontWeight: 700 }}>{r.balance}</div>
              </div>
              <div className="grid md:grid-cols-3 gap-3">
          ...
          {bizList.map(b => (
            <Card key={b.id}>
              <div className="flex items-center gap-3 mb-4">
                <div className="rounded-xl p-2" style={{ background: "rgba(58,91,217,0.1)" }}><Briefcase size={18} color="var(--primary)" /></div>
                <div>
